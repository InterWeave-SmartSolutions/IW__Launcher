...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
	...
	<xsl:template match="iwtransformationserver">
		...
		<xsl:for-each select="iwrecordset/transaction/datamap[@name='payauth']/data/rowset[@name='Envelope']/rowset[@name='Body']/rowset[@name='CreateCustomerProfileTransactionResponse']/rowset[@name='CreateCustomerProfileTransactionResult']/row/col[@name='directResponse']">
			...
			<xsl:if test="not(contains($Result, 'HTML'))">
				...
				<xsl:variable name="RoutingBank">Authorize.net</xsl:variable>
