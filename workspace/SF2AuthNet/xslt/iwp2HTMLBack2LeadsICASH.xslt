...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
	...
	<xsl:template match="iwtransformationserver">
		...
		<xsl:variable name="R1">
			<xsl:for-each select="iwrecordset/transaction/datamap[@name='payauth']/data/rowset[@name='Envelope']/rowset[@name='Body']/rowset[@name='paymentResponse']/rowset[@name='paymentReturn']/rowset[@name='wddxPacket']/rowset[@name='data']/rowset[@name='struct']/rowset[@name='var']">
