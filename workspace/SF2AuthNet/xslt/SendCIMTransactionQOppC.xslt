	...
	<xsl:template match="iwtransformationserver">
		...
		<xsl:for-each select="iwrecordset/transaction/datamap[@name='retrieveacct']/data/rowset[@name='Envelope']/rowset[@name='Body']/rowset[@name='queryResponse']/rowset[@name='result']/rowset[@name='records']">
			<xsl:if test="row/col[@name='Id']">
				...
				<xsl:choose>
					<xsl:when test="($CIMMode='CP' or ($POSMode!='' and starts-with($CIMMode, 'PT'))) and $ProfileId='' and $PaymentProfileId=''">
					...
					<!--<xsl:when test="($CIMMode='CP' or ($POSMode!='' and starts-with($CIMMode, 'PT'))) and $ProfileId!='' and ($PaymentProfileId='' or $POSMode!='')">
						<SOAP-ENV:Envelope xmlns:SOAP-ENV="http://schemas.xmlsoap.org/soap/envelope/" xmlns:SOAP-ENC="http://schemas.xmlsoap.org/soap/encoding/" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:xsd="http://www.w3.org/2001/XMLSchema">
							<SOAP-ENV:Body>
					...
					<xsl:when test="starts-with($CIMMode, 'PT') and $POSMode=''">
						<SOAP-ENV:Envelope xmlns:SOAP-ENV="http://schemas.xmlsoap.org/soap/envelope/" xmlns:SOAP-ENC="http://schemas.xmlsoap.org/soap/encoding/" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:xsd="http://www.w3.org/2001/XMLSchema">
							<SOAP-ENV:Body>
