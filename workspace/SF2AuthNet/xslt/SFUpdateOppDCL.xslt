...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
	...
	<xsl:template match="iwtransformationserver">
		...
		<xsl:variable name="AllowMultiple">
			<xsl:if test="iwrecordset/transaction[@name='sessionvars']/datamap[@name='sessionvars']/data/row/col[@name='__Param__AllowMultiple']">
				<xsl:value-of select="iwrecordset/transaction[@name='sessionvars']/datamap[@name='sessionvars']/data/row/col[@name='__Param__AllowMultiple']"/>
			</xsl:if>
		</xsl:variable>
		...
		<xsl:choose>
			...
			<xsl:otherwise>
				...
				<xsl:variable name="ClearCCInfo0">
					<xsl:if test="iwrecordset/transaction[@name='sessionvars']/datamap[@name='sessionvars']/data/row/col[@name='__Param__ClearCCInfo']">
						<xsl:value-of select="iwrecordset/transaction[@name='sessionvars']/datamap[@name='sessionvars']/data/row/col[@name='__Param__ClearCCInfo']"/>
					</xsl:if>
				</xsl:variable>
				<xsl:variable name="ClearCCInfo">
					<xsl:choose>
						<xsl:when test="$ClearCCInfo0=''">NO</xsl:when>
						<xsl:otherwise>
							<xsl:value-of select="$ClearCCInfo0"/>
						</xsl:otherwise>
					</xsl:choose>
				</xsl:variable>
