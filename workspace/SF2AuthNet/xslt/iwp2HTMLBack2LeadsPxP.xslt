...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
	...
	<xsl:template match="iwtransformationserver">
		...
		<xsl:variable name="R1" select="iwrecordset/transaction/datamap[@name='payauth']/data/row/col[@name='Success']"/>
		<xsl:variable name="R13" select="iwrecordset/transaction/datamap[@name='payauth']/data/row/col[@name='ReferenceNumber']"/>
