		...
		<soap:Envelope xmlns:soap="http://schemas.xmlsoap.org/soap/envelope/" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:xsd="http://www.w3.org/2001/XMLSchema">
			...
			<soap:Body>
				<query xmlns="urn:partner.soap.sforce.com">
					<queryString>Select Id, Name, Gross_Monthly_Charge__c, Credit_Card_Client__c, CC_Exp_Date_00_00__c, FirstName, LastName, Number_of_Declines__c, ACH__c, BillingPostalCode, BillingStreet, Total_Balance__c from Account where Name=? and PersonHasOptedOutOfEmail=false and ACH__c=false and (Client_Status__c='Active' or Client_Status__c='Cancel No Pay') and Special_Billing_2__c=false and Paid_By_Check__pc=false
						</queryString>
				</query>
			</soap:Body>
		</soap:Envelope>
