...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
	...
	<xsl:template match="iwtransformationserver">
		...
		<xsl:variable name="ON">
			<xsl:choose>
				<xsl:when test="$POSMode!='' and not(iwrecordset/transaction/datamap[starts-with(@name, 'payauth')]/data/rowset[@name='Envelope']/rowset[@name='Body']/rowset[@name='CreateCustomerProfileTransactionResponse']/rowset[@name='CreateCustomerProfileTransactionResult']/row/col[@name='directResponse'])">
					<xsl:choose>
						<xsl:when test="$AccountObjectName=''">Account</xsl:when>
						<xsl:otherwise>
		...
		<xsl:choose>
			<xsl:when test="starts-with($CIMMode, 'PT') and iwrecordset/transaction/datamap[starts-with(@name, 'payauth')]/data/rowset[@name='Envelope']/rowset[@name='Body']/rowset[@name='CreateCustomerProfileTransactionResponse']/rowset[@name='CreateCustomerProfileTransactionResult']/row/col[@name='directResponse']">
				<xsl:for-each select="iwrecordset/transaction/datamap[starts-with(@name, 'payauth')]/data/rowset[@name='Envelope']/rowset[@name='Body']/rowset[@name='CreateCustomerProfileTransactionResponse']/rowset[@name='CreateCustomerProfileTransactionResult']/row/col[@name='directResponse']">
					...
					<xsl:if test="not(contains($Result, 'HTML'))">
						...
						<xsl:if test="$R13!=''">
							...
							<xsl:variable name="SFId">
								<xsl:if test="//iwtransformationserver/iwrecordset/transaction/datamap[@name='retrieveacct']/data/rowset[@name='Envelope']/rowset[@name='Body']/rowset[@name='queryResponse']/rowset[@name='result']/rowset[@name='records']/row/col[@name='Id']">
			...
			<xsl:when test="$CIMMode='CP' or ($POSMode!='' and not(iwrecordset/transaction/datamap[starts-with(@name, 'payauth')]/data/rowset[@name='Envelope']/rowset[@name='Body']/rowset[@name='CreateCustomerProfileTransactionResponse']/rowset[@name='CreateCustomerProfileTransactionResult']/row/col[@name='directResponse']) and iwrecordset/transaction/datamap[starts-with(@name, 'payauth')]/data/rowset[@name='Envelope']/rowset[@name='Body']/rowset[@name='CreateCustomerProfileResponse']/rowset[@name='CreateCustomerProfileResult']/rowset[@name='messages']/rowset[@name='MessagesTypeMessage']/row/col[@name='code'])">
				<xsl:for-each select="iwrecordset/transaction/datamap[starts-with(@name, 'payauth')]/data/rowset[@name='Envelope']/rowset[@name='Body']/rowset[@name='CreateCustomerProfileResponse']/rowset[@name='CreateCustomerProfileResult']">
					<xsl:variable name="R1" select="rowset[@name='messages']/rowset[@name='MessagesTypeMessage']/row/col[@name='code']"/>
					<xsl:variable name="R4" select="rowset[@name='messages']/rowset[@name='MessagesTypeMessage']/row/col[@name='text']"/>
					<xsl:variable name="R7">
						<xsl:if test="row/col[@name='customerProfileId']">
							<xsl:value-of select="row/col[@name='customerProfileId']"/>
						</xsl:if>
					</xsl:variable>
					<xsl:variable name="R10">
						<xsl:if test="rowset[@name='customerPaymentProfileIdList']/row/col[@name='long']">
							<xsl:value-of select="rowset[@name='customerPaymentProfileIdList']/row/col[@name='long']"/>
						</xsl:if>
					</xsl:variable>
					...
					<xsl:variable name="Decl0" select="//iwtransformationserver/iwrecordset/transaction/datamap[@name='retrieveacct']/data/rowset[@name='Envelope']/rowset[@name='Body']/rowset[@name='queryResponse']/rowset[@name='result']/rowset[@name='records']/row/col[@name='Number_of_Declines__c']"/>
					<xsl:variable name="Decl">
						<xsl:choose>
							<xsl:when test="$Decl0!=''">
								<xsl:value-of select="$Decl0+1"/>
					...
					<xsl:choose>
								...
								<soap:Body>
									<update xmlns="urn:partner.soap.sforce.com">
										<sObjects>
											...
											<xsl:if test="$CIMMode='CP'">
												<Customer_Profile_Id__c>
													<xsl:value-of select="$R7"/>
												</Customer_Profile_Id__c>
											</xsl:if>
											<Customer_Payment_Profile_Id__c>
						...
						<xsl:otherwise>
							<soap:Envelope xmlns:soap="http://schemas.xmlsoap.org/soap/envelope/" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:xsd="http://www.w3.org/2001/XMLSchema">
								...
								<xsl:variable name="BCC" select="//iwtransformationserver/iwrecordset/transaction[@name='sessionvars']/datamap[@name='sessionvars']/data/row/col[@name='BCCEmail']"/>
								<xsl:if test="$To!='' or $CC!='' or $BCC!=''">
									<xsl:variable name="ErrorType">failed</xsl:variable>
									<soap:Envelope xmlns:soap="http://schemas.xmlsoap.org/soap/envelope/" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:xsd="http://www.w3.org/2001/XMLSchema">
										<soap:Header>
											<SessionHeader xmlns="urn:partner.soap.sforce.com">
												<sessionId>
			...
			<xsl:when test="$CIMMode='CP' or ($POSMode!='' and not(iwrecordset/transaction/datamap[starts-with(@name, 'payauth')]/data/rowset[@name='Envelope']/rowset[@name='Body']/rowset[@name='CreateCustomerProfileTransactionResponse']/rowset[@name='CreateCustomerProfileTransactionResult']/row/col[@name='directResponse']) and iwrecordset/transaction/datamap[starts-with(@name, 'payauth')]/data/rowset[@name='Envelope']/rowset[@name='Body']/rowset[@name='CreateCustomerPaymentProfileResponse']/rowset[@name='CreateCustomerPaymentProfileResult']/rowset[@name='messages']/rowset[@name='MessagesTypeMessage']/row/col[@name='code'])">
				<xsl:for-each select="iwrecordset/transaction/datamap[starts-with(@name, 'payauth')]/data/rowset[@name='Envelope']/rowset[@name='Body']/rowset[@name='CreateCustomerProfileResponse']/rowset[@name='CreateCustomerProfileResult']">
					<xsl:variable name="R1" select="rowset[@name='messages']/rowset[@name='MessagesTypeMessage']/row/col[@name='code']"/>
					<xsl:variable name="R4" select="rowset[@name='messages']/rowset[@name='MessagesTypeMessage']/row/col[@name='text']"/>
					<xsl:variable name="R7">
