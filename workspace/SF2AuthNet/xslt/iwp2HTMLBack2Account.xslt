...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
	...
	<xsl:template match="iwtransformationserver">
		...
		<xsl:variable name="Result">
			<xsl:choose>
				<xsl:when test="iwrecordset/transaction/datamap[starts-with(@name, 'payauth')]/data/row/col[@name='Result']">
					<xsl:value-of select="iwrecordset/transaction/datamap[starts-with(@name, 'payauth')]/data/row/col[@name='Result']"/>
				</xsl:when>
				<xsl:when test="iwrecordset/transaction/datamap[starts-with(@name, 'payauth')]/data/rowset[@name='Envelope']/rowset[@name='Body']/rowset/rowset/rowset[starts-with(@name, 'validationDirectResponse')]/row/col[@name='string']">
					<xsl:value-of select="iwrecordset/transaction/datamap[starts-with(@name, 'payauth')]/data/rowset[@name='Envelope']/rowset[@name='Body']/rowset/rowset/rowset[starts-with(@name, 'validationDirectResponse')]/row/col[@name='string']"/>
				</xsl:when>
			</xsl:choose>
		</xsl:variable>
