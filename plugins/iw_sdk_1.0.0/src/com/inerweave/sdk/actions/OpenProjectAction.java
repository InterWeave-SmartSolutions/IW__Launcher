...
extends Action {
    ...
    public OpenProjectAction(String text, IWorkbenchWindow window) {
        super(text);
        this.window = window;
        this.setId("iw_sdk.openProject");
        this.setActionDefinitionId("iw_sdk.openProject");
        this.setImageDescriptor(ImageDescriptor.createFromImage((Image)PlatformUI.getWorkbench().getSharedImages().getImage("IMG_OBJ_PROJECT")));
    }
        ...
        if (nv != null) {
            ...
            while (n < n2) {
                ...
                try {
                    ...
                    MessageDialog.openError((Shell)this.window.getShell(), (String)"Project Error", (String)("Unable to open active project: " + e.toString()));
                    return;
                }
                ++n;
            }
