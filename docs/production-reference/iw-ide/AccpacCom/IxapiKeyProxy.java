...
/**
 * Proxy for COM Interface 'IxapiKey'. Generated 06/10/2006 6:20:01 PM
 ...
 *   DontOverwrite = False
 */
public class IxapiKeyProxy extends com.linar.jintegra.Dispatch implements com.interweave.plugin.A4WCOM.IxapiKey, java.io.Serializable {

  protected String getJintegraVersion() { return "2.6"; }

  static { com.interweave.plugin.A4WCOM.JIntegraInit.init(); }

  public static final Class targetClass = IxapiKey.class;

  public IxapiKeyProxy(String CLSID, String host, AuthInfo authInfo) throws java.net.UnknownHostException, java.io.IOException{
    super(CLSID, IxapiKey.IID, host, authInfo);
  }

  /** For internal use only */
  public IxapiKeyProxy() {}

  public IxapiKeyProxy(Object obj) throws java.io.IOException {
    super(obj, IxapiKey.IID);
  }

  protected IxapiKeyProxy(Object obj, String iid) throws java.io.IOException {
    super(obj, iid);
  }

  protected IxapiKeyProxy(String CLSID, String iid, String host, AuthInfo authInfo) throws java.io.IOException {
  ...
  public com.interweave.plugin.A4WCOM.IxapiFields getFields  () throws java.io.IOException, com.linar.jintegra.AutomationException{
    ...
    Object zz_parameters[] = { zz_retVal };
    vtblInvoke("getFields", 8, zz_parameters);
  ...
  static {
    com.linar.jintegra.InterfaceDesc.add("bc2cc403-9ceb-11d1-b5c6-0060083b07c8", com.interweave.plugin.A4WCOM.IxapiKeyProxy.class, null, 7, new com.linar.jintegra.MemberDesc[] {
