...
/**
 * Proxy for COM Interface 'IxapiView2'. Generated 06/10/2006 6:20:01 PM
 ...
 *   DontOverwrite = False
 */
public class IxapiView2Proxy extends com.interweave.plugin.A4WCOM.IxapiViewProxy implements com.interweave.plugin.A4WCOM.IxapiView2, java.io.Serializable {

  protected String getJintegraVersion() { return "2.6"; }

  static { com.interweave.plugin.A4WCOM.JIntegraInit.init(); }

  public static final Class targetClass = IxapiView2.class;

  public IxapiView2Proxy(String CLSID, String host, AuthInfo authInfo) throws java.net.UnknownHostException, java.io.IOException{
    super(CLSID, IxapiView2.IID, host, authInfo);
  }

  /** For internal use only */
  public IxapiView2Proxy() {}

  public IxapiView2Proxy(Object obj) throws java.io.IOException {
    super(obj, IxapiView2.IID);
  }

  protected IxapiView2Proxy(Object obj, String iid) throws java.io.IOException {
    super(obj, iid);
  }

  protected IxapiView2Proxy(String CLSID, String iid, String host, AuthInfo authInfo) throws java.io.IOException {
  ...
  public String getTitle  () throws java.io.IOException, com.linar.jintegra.AutomationException{
    ...
    vtblInvoke("getTitle", 47, zz_parameters);
  ...
  public int getUnpostedRevisions  () throws java.io.IOException, com.linar.jintegra.AutomationException{
    int zz_retVal[] = { 0 };
    Object zz_parameters[] = { zz_retVal };
    vtblInvoke("getUnpostedRevisions", 48, zz_parameters);
    return zz_retVal[0];
  }
  ...
  public int getReferentialIntegrity  () throws java.io.IOException, com.linar.jintegra.AutomationException{
    int zz_retVal[] = { 0 };
    Object zz_parameters[] = { zz_retVal };
    vtblInvoke("getReferentialIntegrity", 49, zz_parameters);
    return zz_retVal[0];
  }
  ...
  public void setReferentialIntegrity  (
    ...
    vtblInvoke("setReferentialIntegrity", 50, zz_parameters);
    return;
  }
  ...
  public int getSystemAccess  () throws java.io.IOException, com.linar.jintegra.AutomationException{
    int zz_retVal[] = { 0 };
    Object zz_parameters[] = { zz_retVal };
    vtblInvoke("getSystemAccess", 51, zz_parameters);
    return zz_retVal[0];
  }
  ...
  public void setSystemAccess  (
    ...
    Object zz_retVal[] = { null };
    Object zz_parameters[] = { new Integer(pVal), zz_retVal };
    vtblInvoke("setSystemAccess", 52, zz_parameters);
    return;
  }
  ...
  static {
    com.linar.jintegra.InterfaceDesc.add("6d9e7425-e2e5-11d2-9bee-00104b71eb3f", com.interweave.plugin.A4WCOM.IxapiView2Proxy.class, "351fa047-8c34-11d1-b5ab-0060083b07c8", 47, new com.linar.jintegra.MemberDesc[] {
        new com.linar.jintegra.MemberDesc("getTitle",
            new Class[] { },
            new com.linar.jintegra.Param[] { 
              new com.linar.jintegra.Param("pVal", 8, 20, 8, null, null) }),
        new com.linar.jintegra.MemberDesc("getUnpostedRevisions",
            new Class[] { },
            new com.linar.jintegra.Param[] { 
