...
/**
 * Proxy for COM Interface 'IxapiActiveApplications'. Generated 06/10/2006 6:20:01 PM
 ...
 *   DontOverwrite = False
 */
public class IxapiActiveApplicationsProxy extends com.linar.jintegra.Dispatch implements com.interweave.plugin.A4WCOM.IxapiActiveApplications, java.io.Serializable {

  protected String getJintegraVersion() { return "2.6"; }

  static { com.interweave.plugin.A4WCOM.JIntegraInit.init(); }

  public static final Class targetClass = IxapiActiveApplications.class;

  public IxapiActiveApplicationsProxy(String CLSID, String host, AuthInfo authInfo) throws java.net.UnknownHostException, java.io.IOException{
    super(CLSID, IxapiActiveApplications.IID, host, authInfo);
  }

  /** For internal use only */
  public IxapiActiveApplicationsProxy() {}

  public IxapiActiveApplicationsProxy(Object obj) throws java.io.IOException {
    super(obj, IxapiActiveApplications.IID);
  }

  protected IxapiActiveApplicationsProxy(Object obj, String iid) throws java.io.IOException {
    super(obj, iid);
  }

  protected IxapiActiveApplicationsProxy(String CLSID, String iid, String host, AuthInfo authInfo) throws java.io.IOException {
  ...
  public com.interweave.plugin.A4WCOM.IxapiApplication getApplication  (
    ...
    com.interweave.plugin.A4WCOM.IxapiApplication zz_retVal[] = { null };
    Object zz_parameters[] = { new Integer(index), zz_retVal };
    vtblInvoke("getApplication", 8, zz_parameters);
    return (com.interweave.plugin.A4WCOM.IxapiApplication)zz_retVal[0];
  }
  ...
  static {
    com.linar.jintegra.InterfaceDesc.add("0631ecca-91ac-11d1-b5b5-0060083b07c8", com.interweave.plugin.A4WCOM.IxapiActiveApplicationsProxy.class, null, 7, new com.linar.jintegra.MemberDesc[] {
        ...
        new com.linar.jintegra.MemberDesc("getApplication",
            ...
            new com.linar.jintegra.Param[] { 
              ...
              new com.linar.jintegra.Param("ixapiApplication", 29, 20, 4, com.interweave.plugin.A4WCOM.IxapiApplication.IID, com.interweave.plugin.A4WCOM.IxapiApplicationProxy.class) }),
