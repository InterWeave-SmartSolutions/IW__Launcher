...
/**
 * Proxy for COM Interface 'A4WUtl_Dispatch'. Generated 18/10/2006 4:32:53 PM
 ...
 *   DontOverwrite = False
 */
public class A4WUtl_DispatchProxy extends com.linar.jintegra.Dispatch implements com.interweave.plugin.A4WEEADV.A4WUtl_Dispatch, java.io.Serializable {

  protected String getJintegraVersion() { return "2.6"; }

  static { com.interweave.plugin.A4WEEADV.JIntegraInit.init(); }

  public static final Class targetClass = A4WUtl_Dispatch.class;

  public A4WUtl_DispatchProxy(String CLSID, String host, AuthInfo authInfo) throws java.net.UnknownHostException, java.io.IOException{
    super(CLSID, A4WUtl_Dispatch.IID, host, authInfo);
  }

  /** For internal use only */
  public A4WUtl_DispatchProxy() {}

  public A4WUtl_DispatchProxy(Object obj) throws java.io.IOException {
    super(obj, A4WUtl_Dispatch.IID);
  }

  protected A4WUtl_DispatchProxy(Object obj, String iid) throws java.io.IOException {
    super(obj, iid);
  }

  protected A4WUtl_DispatchProxy(String CLSID, String iid, String host, AuthInfo authInfo) throws java.io.IOException {
  ...
  static {
    com.linar.jintegra.InterfaceDesc.add("25046420-f1f2-415c-bc41-ae01b178475f", com.interweave.plugin.A4WEEADV.A4WUtl_DispatchProxy.class, null, 0, null );
  }
}
