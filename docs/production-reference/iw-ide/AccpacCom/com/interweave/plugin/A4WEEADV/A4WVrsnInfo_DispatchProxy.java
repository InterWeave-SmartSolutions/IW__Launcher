...
/**
 * Proxy for COM Interface 'A4WVrsnInfo_Dispatch'. Generated 18/10/2006 4:32:53 PM
 ...
 *   DontOverwrite = False
 */
public class A4WVrsnInfo_DispatchProxy extends com.linar.jintegra.Dispatch implements com.interweave.plugin.A4WEEADV.A4WVrsnInfo_Dispatch, java.io.Serializable {

  protected String getJintegraVersion() { return "2.6"; }

  static { com.interweave.plugin.A4WEEADV.JIntegraInit.init(); }

  public static final Class targetClass = A4WVrsnInfo_Dispatch.class;

  public A4WVrsnInfo_DispatchProxy(String CLSID, String host, AuthInfo authInfo) throws java.net.UnknownHostException, java.io.IOException{
    super(CLSID, A4WVrsnInfo_Dispatch.IID, host, authInfo);
  }

  /** For internal use only */
  public A4WVrsnInfo_DispatchProxy() {}

  public A4WVrsnInfo_DispatchProxy(Object obj) throws java.io.IOException {
    super(obj, A4WVrsnInfo_Dispatch.IID);
  }

  protected A4WVrsnInfo_DispatchProxy(Object obj, String iid) throws java.io.IOException {
    super(obj, iid);
  }

  protected A4WVrsnInfo_DispatchProxy(String CLSID, String iid, String host, AuthInfo authInfo) throws java.io.IOException {
  ...
  public Object getDate  () throws java.io.IOException, com.linar.jintegra.AutomationException{
    com.linar.jintegra.Variant[] parameters = {};
    return invoke("getDate", 100, 2, parameters).getDISPATCH();
  }
  ...
  public String getVersion  () throws java.io.IOException, com.linar.jintegra.AutomationException{
    com.linar.jintegra.Variant[] parameters = {};
    return invoke("getVersion", 102, 1, parameters).getBSTR();
  }
  ...
  public int zz_hashCode  () throws java.io.IOException, com.linar.jintegra.AutomationException{
    com.linar.jintegra.Variant[] parameters = {};
    return invoke("zz_hashCode", 103, 1, parameters).getI4();
  }
  ...
  public String getVersion2  () throws java.io.IOException, com.linar.jintegra.AutomationException{
    com.linar.jintegra.Variant[] parameters = {};
    return invoke("getVersion2", 105, 2, parameters).getBSTR();
  }
  ...
  public Object getDate2  () throws java.io.IOException, com.linar.jintegra.AutomationException{
    com.linar.jintegra.Variant[] parameters = {};
    return invoke("getDate2", 107, 1, parameters).getDISPATCH();
  }
  ...
  public void zz_notifyAll  () throws java.io.IOException, com.linar.jintegra.AutomationException{
    com.linar.jintegra.Variant[] parameters = {};
    invoke("zz_notifyAll", 110, 1, parameters);
    return;
  }
  ...
  public void a4WVrsnInfo  () throws java.io.IOException, com.linar.jintegra.AutomationException{
    com.linar.jintegra.Variant[] parameters = {};
    invoke("a4WVrsnInfo", 111, 1, parameters);
    return;
  }
  ...
  static {
    com.linar.jintegra.InterfaceDesc.add("0c16d3df-273c-475e-8024-acb3f53b54be", com.interweave.plugin.A4WEEADV.A4WVrsnInfo_DispatchProxy.class, null, 0, null );
  }
}
