...
/**
 * Proxy for COM Interface 'A4WKeyInfo_Dispatch'. Generated 18/10/2006 4:32:52 PM
 ...
 *   DontOverwrite = False
 */
public class A4WKeyInfo_DispatchProxy extends com.linar.jintegra.Dispatch implements com.interweave.plugin.A4WEEADV.A4WKeyInfo_Dispatch, java.io.Serializable {

  protected String getJintegraVersion() { return "2.6"; }

  static { com.interweave.plugin.A4WEEADV.JIntegraInit.init(); }

  public static final Class targetClass = A4WKeyInfo_Dispatch.class;

  public A4WKeyInfo_DispatchProxy(String CLSID, String host, AuthInfo authInfo) throws java.net.UnknownHostException, java.io.IOException{
    super(CLSID, A4WKeyInfo_Dispatch.IID, host, authInfo);
  }

  /** For internal use only */
  public A4WKeyInfo_DispatchProxy() {}

  public A4WKeyInfo_DispatchProxy(Object obj) throws java.io.IOException {
    super(obj, A4WKeyInfo_Dispatch.IID);
  }

  protected A4WKeyInfo_DispatchProxy(Object obj, String iid) throws java.io.IOException {
    super(obj, iid);
  }

  protected A4WKeyInfo_DispatchProxy(String CLSID, String iid, String host, AuthInfo authInfo) throws java.io.IOException {
  ...
  public String getName  () throws java.io.IOException, com.linar.jintegra.AutomationException{
    com.linar.jintegra.Variant[] parameters = {};
    return invoke("getName", 100, 2, parameters).getBSTR();
  }
  ...
  public int getNumFields  () throws java.io.IOException, com.linar.jintegra.AutomationException{
    com.linar.jintegra.Variant[] parameters = {};
    return invoke("getNumFields", 103, 1, parameters).getI4();
  }
  ...
  public int getFields  (
    ...
    return invoke("getFields", 104, 1, parameters).getI4();
  }
  ...
  public String zz_toString  () throws java.io.IOException, com.linar.jintegra.AutomationException{
    com.linar.jintegra.Variant[] parameters = {};
    return invoke("zz_toString", 105, 1, parameters).getBSTR();
  }
  ...
  public boolean zz_equals  (
    ...
    return invoke("zz_equals", 106, 1, parameters).getBOOL();
  }
  ...
  public int getFields2  (
    ...
    return invoke("getFields2", 107, 2, parameters).getI4();
  }
  ...
  public String getName2  () throws java.io.IOException, com.linar.jintegra.AutomationException{
    com.linar.jintegra.Variant[] parameters = {};
    return invoke("getName2", 108, 1, parameters).getBSTR();
  }
  ...
  public int getNumFields2  () throws java.io.IOException, com.linar.jintegra.AutomationException{
    com.linar.jintegra.Variant[] parameters = {};
    return invoke("getNumFields2", 109, 2, parameters).getI4();
  }
  ...
  static {
    com.linar.jintegra.InterfaceDesc.add("34198f60-9902-4204-a2f1-29185b8a64bf", com.interweave.plugin.A4WEEADV.A4WKeyInfo_DispatchProxy.class, null, 0, null );
  }
}
