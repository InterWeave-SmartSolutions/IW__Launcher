...
/**
 * Proxy for COM Interface 'A4WReport_Dispatch'. Generated 18/10/2006 4:32:53 PM
 ...
 *   DontOverwrite = False
 */
public class A4WReport_DispatchProxy extends com.linar.jintegra.Dispatch implements com.interweave.plugin.A4WEEADV.A4WReport_Dispatch, java.io.Serializable {

  protected String getJintegraVersion() { return "2.6"; }

  static { com.interweave.plugin.A4WEEADV.JIntegraInit.init(); }

  public static final Class targetClass = A4WReport_Dispatch.class;

  public A4WReport_DispatchProxy(String CLSID, String host, AuthInfo authInfo) throws java.net.UnknownHostException, java.io.IOException{
    super(CLSID, A4WReport_Dispatch.IID, host, authInfo);
  }

  /** For internal use only */
  public A4WReport_DispatchProxy() {}

  public A4WReport_DispatchProxy(Object obj) throws java.io.IOException {
    super(obj, A4WReport_Dispatch.IID);
  }

  protected A4WReport_DispatchProxy(Object obj, String iid) throws java.io.IOException {
    super(obj, iid);
  }

  protected A4WReport_DispatchProxy(String CLSID, String iid, String host, AuthInfo authInfo) throws java.io.IOException {
  ...
  public void setParam  (
    ...
    invoke("setParam", 103, 1, parameters);
    return;
  }
  ...
  public String print2  (
    ...
    com.linar.jintegra.Variant[] parameters = {new Variant("parameter0", 3, parameter0),
                                         new Variant("parameter1", 3, parameter1),
                                         new Variant("parameter2", 8, parameter2),};
    return invoke("print2", 107, 1, parameters).getBSTR();
  }
  ...
  public void printX  (
    ...
    com.linar.jintegra.Variant[] parameters = {new Variant("parameter0", 3, parameter0),
                                         new Variant("parameter1", 3, parameter1),
                                         new Variant("parameter2", 8, parameter2),};
    invoke("printX", 108, 1, parameters);
    return;
  }
  ...
  public void select  (
    ...
    com.linar.jintegra.Variant[] parameters = {new Variant("parameter0", 9, parameter0),
                                         new Variant("parameter1", 8, parameter1),
                                         new Variant("parameter2", 8, parameter2),};
    invoke("select", 111, 1, parameters);
    return;
  }
  ...
  static {
    com.linar.jintegra.InterfaceDesc.add("e2a0c2a9-55e1-4ad4-8c1e-12021e5e06a3", com.interweave.plugin.A4WEEADV.A4WReport_DispatchProxy.class, null, 0, null );
  }
}
