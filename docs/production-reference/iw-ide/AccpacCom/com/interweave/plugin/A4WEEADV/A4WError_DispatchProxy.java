...
/**
 * Proxy for COM Interface 'A4WError_Dispatch'. Generated 18/10/2006 4:32:52 PM
 ...
 *   DontOverwrite = False
 */
public class A4WError_DispatchProxy extends com.linar.jintegra.Dispatch implements com.interweave.plugin.A4WEEADV.A4WError_Dispatch, java.io.Serializable {

  protected String getJintegraVersion() { return "2.6"; }

  static { com.interweave.plugin.A4WEEADV.JIntegraInit.init(); }

  public static final Class targetClass = A4WError_Dispatch.class;

  public A4WError_DispatchProxy(String CLSID, String host, AuthInfo authInfo) throws java.net.UnknownHostException, java.io.IOException{
    super(CLSID, A4WError_Dispatch.IID, host, authInfo);
  }

  /** For internal use only */
  public A4WError_DispatchProxy() {}

  public A4WError_DispatchProxy(Object obj) throws java.io.IOException {
    super(obj, A4WError_Dispatch.IID);
  }

  protected A4WError_DispatchProxy(Object obj, String iid) throws java.io.IOException {
    super(obj, iid);
  }

  protected A4WError_DispatchProxy(String CLSID, String iid, String host, AuthInfo authInfo) throws java.io.IOException {
  ...
  public String get  (
    ...
    return invoke("get", 100, 2, parameters).getBSTR();
  }
  ...
  public String get2  (
    ...
    return invoke("get2", 101, 1, parameters).getBSTR();
  }
  ...
  public int count  () throws java.io.IOException, com.linar.jintegra.AutomationException{
    com.linar.jintegra.Variant[] parameters = {};
    return invoke("count", 104, 1, parameters).getI4();
  }
  ...
  public void setSession  (
    ...
    invoke("setSession", 106, 1, parameters);
    return;
  }
  ...
  public void setSession2  (
    ...
    invoke("setSession2", 111, 4, parameters);
    return;
  }
  ...
  static {
    com.linar.jintegra.InterfaceDesc.add("a9ead432-28ec-4480-a8c0-27931b12dd7b", com.interweave.plugin.A4WEEADV.A4WError_DispatchProxy.class, null, 0, null );
  }
}
