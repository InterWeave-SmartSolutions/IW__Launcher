...
/**
 * Proxy for COM Interface 'A4WCommInteger_Dispatch'. Generated 18/10/2006 4:32:52 PM
 ...
 *   DontOverwrite = False
 */
public class A4WCommInteger_DispatchProxy extends com.linar.jintegra.Dispatch implements com.interweave.plugin.A4WEEADV.A4WCommInteger_Dispatch, java.io.Serializable {

  protected String getJintegraVersion() { return "2.6"; }

  static { com.interweave.plugin.A4WEEADV.JIntegraInit.init(); }

  public static final Class targetClass = A4WCommInteger_Dispatch.class;

  public A4WCommInteger_DispatchProxy(String CLSID, String host, AuthInfo authInfo) throws java.net.UnknownHostException, java.io.IOException{
    super(CLSID, A4WCommInteger_Dispatch.IID, host, authInfo);
  }

  /** For internal use only */
  public A4WCommInteger_DispatchProxy() {}

  public A4WCommInteger_DispatchProxy(Object obj) throws java.io.IOException {
    super(obj, A4WCommInteger_Dispatch.IID);
  }

  protected A4WCommInteger_DispatchProxy(Object obj, String iid) throws java.io.IOException {
    super(obj, iid);
  }

  protected A4WCommInteger_DispatchProxy(String CLSID, String iid, String host, AuthInfo authInfo) throws java.io.IOException {
  ...
  public void zz_notify  () throws java.io.IOException, com.linar.jintegra.AutomationException{
    com.linar.jintegra.Variant[] parameters = {};
    invoke("zz_notify", 104, 1, parameters);
    return;
  }
  ...
  public Object zz_getClass  () throws java.io.IOException, com.linar.jintegra.AutomationException{
    com.linar.jintegra.Variant[] parameters = {};
    return invoke("zz_getClass", 105, 1, parameters).getDISPATCH();
  }
  ...
  public void zz_notifyAll  () throws java.io.IOException, com.linar.jintegra.AutomationException{
    com.linar.jintegra.Variant[] parameters = {};
    invoke("zz_notifyAll", 106, 1, parameters);
    return;
  }
  ...
  static {
    com.linar.jintegra.InterfaceDesc.add("28e222cc-f162-4e87-8b80-e182c842bc53", com.interweave.plugin.A4WEEADV.A4WCommInteger_DispatchProxy.class, null, 0, null );
  }
}
