...
/**
 * Proxy for COM Interface 'A4WBlkGet_Dispatch'. Generated 18/10/2006 4:32:52 PM
 ...
 *   DontOverwrite = False
 */
public class A4WBlkGet_DispatchProxy extends com.linar.jintegra.Dispatch implements com.interweave.plugin.A4WEEADV.A4WBlkGet_Dispatch, java.io.Serializable {

  protected String getJintegraVersion() { return "2.6"; }

  static { com.interweave.plugin.A4WEEADV.JIntegraInit.init(); }

  public static final Class targetClass = A4WBlkGet_Dispatch.class;

  public A4WBlkGet_DispatchProxy(String CLSID, String host, AuthInfo authInfo) throws java.net.UnknownHostException, java.io.IOException{
    super(CLSID, A4WBlkGet_Dispatch.IID, host, authInfo);
  }

  /** For internal use only */
  public A4WBlkGet_DispatchProxy() {}

  public A4WBlkGet_DispatchProxy(Object obj) throws java.io.IOException {
    super(obj, A4WBlkGet_Dispatch.IID);
  }

  protected A4WBlkGet_DispatchProxy(Object obj, String iid) throws java.io.IOException {
    super(obj, iid);
  }

  protected A4WBlkGet_DispatchProxy(String CLSID, String iid, String host, AuthInfo authInfo) throws java.io.IOException {
  ...
  public String toNumString  (
    ...
    return invoke("toNumString", 102, 1, parameters).getBSTR();
  }
  ...
  public int toInt  (
    ...
    com.linar.jintegra.Variant[] parameters = {new Variant("parameter0", 3, parameter0),};
    return invoke("toInt", 103, 1, parameters).getI4();
  }
  ...
  public boolean toBoolean  (
              int parameter0) throws java.io.IOException, com.linar.jintegra.AutomationException{
    com.linar.jintegra.Variant[] parameters = {new Variant("parameter0", 3, parameter0),};
    return invoke("toBoolean", 105, 1, parameters).getBOOL();
  }
  ...
  public int blkGet  (
    ...
    return invoke("blkGet", 106, 1, parameters).getI4();
  }
  ...
  public int toShort  (
              int parameter0) throws java.io.IOException, com.linar.jintegra.AutomationException{
    com.linar.jintegra.Variant[] parameters = {new Variant("parameter0", 3, parameter0),};
    return invoke("toShort", 107, 1, parameters).getI4();
  }
  ...
  public Object toByteArray  (
              int parameter0) throws java.io.IOException, com.linar.jintegra.AutomationException{
    com.linar.jintegra.Variant[] parameters = {new Variant("parameter0", 3, parameter0),};
    return invoke("toByteArray", 108, 1, parameters).getVARIANT();
  }
  ...
  public Object zz_toString  (
              Object[] parameter0) throws java.io.IOException, com.linar.jintegra.AutomationException{
    com.linar.jintegra.Variant[] parameters = {new Variant("parameter0", 16396, parameter0),};
    return invoke("zz_toString", 109, 1, parameters).getVARIANT();
  }
  ...
  public boolean zz_equals  (
              Object parameter0) throws java.io.IOException, com.linar.jintegra.AutomationException{
    com.linar.jintegra.Variant[] parameters = {new Variant("parameter0", 9, parameter0),};
    return invoke("zz_equals", 110, 1, parameters).getBOOL();
  }
  ...
  public void zz_notify  () throws java.io.IOException, com.linar.jintegra.AutomationException{
    com.linar.jintegra.Variant[] parameters = {};
    invoke("zz_notify", 111, 1, parameters);
    return;
  }
  ...
  public Object zz_getClass  () throws java.io.IOException, com.linar.jintegra.AutomationException{
    com.linar.jintegra.Variant[] parameters = {};
    return invoke("zz_getClass", 112, 1, parameters).getDISPATCH();
  }
  ...
  public void zz_notifyAll  () throws java.io.IOException, com.linar.jintegra.AutomationException{
    com.linar.jintegra.Variant[] parameters = {};
    invoke("zz_notifyAll", 113, 1, parameters);
    return;
  }
  ...
  public int toByte  (
              int parameter0) throws java.io.IOException, com.linar.jintegra.AutomationException{
    com.linar.jintegra.Variant[] parameters = {new Variant("parameter0", 3, parameter0),};
    return invoke("toByte", 114, 1, parameters).getI4();
  }
  ...
  public int toChar  (
              int parameter0) throws java.io.IOException, com.linar.jintegra.AutomationException{
    com.linar.jintegra.Variant[] parameters = {new Variant("parameter0", 3, parameter0),};
    return invoke("toChar", 115, 1, parameters).getI4();
  }
  ...
  static {
    com.linar.jintegra.InterfaceDesc.add("ec447d31-ecc0-4121-a477-4a51eb321b0a", com.interweave.plugin.A4WEEADV.A4WBlkGet_DispatchProxy.class, null, 0, null );
  }
}
