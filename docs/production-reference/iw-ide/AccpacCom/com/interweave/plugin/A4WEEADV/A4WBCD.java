...
/**
 * COM Class 'A4WBCD'. Generated 18/10/2006 4:32:52 PM
 ...
 *   DontOverwrite = False
 */
public class A4WBCD implements com.linar.jintegra.RemoteObjRef, com.interweave.plugin.A4WEEADV.A4WBCD_Dispatch {

  private static final String CLSID = "2ca70005-e03b-11d2-8521-00104b1f474e";

  protected String getJintegraVersion() { return "2.6"; }

  // Interface delegates
  private com.interweave.plugin.A4WEEADV.A4WBCD_DispatchProxy d_A4WBCD_DispatchProxy = null;

  /** Access this COM class's com.interweave.plugin.A4WEEADV.A4WBCD_Dispatch interface */
  public com.interweave.plugin.A4WEEADV.A4WBCD_Dispatch getAsA4WBCD_Dispatch() { return d_A4WBCD_DispatchProxy; }
   ...
   */
  public static A4WBCD getActiveObject() throws com.linar.jintegra.AutomationException, java.io.IOException {
    return new A4WBCD(com.linar.jintegra.Dispatch.getActiveObject(CLSID));
  }
   ...
   * @exception com.linar.jintegra.AutomationException If there was an error attaching to the instance.
   */
  public static A4WBCD bindUsingMoniker(String moniker) throws com.linar.jintegra.AutomationException, java.io.IOException {
    return new A4WBCD(com.linar.jintegra.Dispatch.bindUsingMoniker(moniker));
  }

  /** J-Integra for COM internal method */
  public com.linar.jintegra.Dispatch getJintegraDispatch() {  return d_A4WBCD_DispatchProxy; }

  /**
   * Constructs a A4WBCD on the local host.
   ...
   */
  public A4WBCD() throws java.io.IOException, java.net.UnknownHostException {
    this("localhost");
  }

  /**
   * Construct a A4WBCD on specified host.
   * @param     host  the host on which the object should be created
   * @exception java.io.IOException if there are problems communicating via DCOM 
   * @exception java.net.UnknownHostException if the host can not be found 
   */
  public A4WBCD(String host) throws java.io.IOException, java.net.UnknownHostException {
    d_A4WBCD_DispatchProxy = new com.interweave.plugin.A4WEEADV.A4WBCD_DispatchProxy(CLSID, host, null);
  }

  /**
   * Construct a A4WBCD using a reference to such an object returned from a COM server
   * @param     obj an object returned from a COM server
   * @exception java.io.IOException if there are problems communicating via DCOM 
   */
  public A4WBCD(Object obj) throws java.io.IOException {
    d_A4WBCD_DispatchProxy = new com.interweave.plugin.A4WEEADV.A4WBCD_DispatchProxy(obj);
  }
   ...
   */
  public void release() {
    com.linar.jintegra.Cleaner.release(d_A4WBCD_DispatchProxy);
  }
  ...
  public Object getPropertyByName(String name) throws NoSuchFieldException, java.io.IOException, com.linar.jintegra.AutomationException {
    try {
      return d_A4WBCD_DispatchProxy.getPropertyByName(name);
  ...
  public Object getPropertyByName(String name, Object rhs) throws NoSuchFieldException, java.io.IOException, com.linar.jintegra.AutomationException {
    try {
      return d_A4WBCD_DispatchProxy.getPropertyByName(name, rhs);
    } catch(com.linar.jintegra.AutomationException automationException) {
      automationException.fillInStackTrace();
      throw automationException;
    } catch(NoSuchFieldException noSuchFieldException) {
  ...
  public Object invokeMethodByName(String name, Object[] parameters) throws NoSuchMethodException, java.io.IOException, com.linar.jintegra.AutomationException {
    return d_A4WBCD_DispatchProxy.invokeMethodByName(name, parameters);
  }
  ...
  public Object invokeMethodByName(String name) throws NoSuchMethodException, java.io.IOException, com.linar.jintegra.AutomationException {
    return d_A4WBCD_DispatchProxy.invokeMethodByName(name, new Object[]{});
  }
  ...
  public Object zz_wait  (
    ...
    try {
      return d_A4WBCD_DispatchProxy.zz_wait(parameter0,parameter1);
    } catch(com.linar.jintegra.AutomationException automationException) {
      automationException.fillInStackTrace();
      throw automationException;
    }
  ...
  public int zz_hashCode  () throws java.io.IOException, com.linar.jintegra.AutomationException {
    try {
      return d_A4WBCD_DispatchProxy.zz_hashCode();
    } catch(com.linar.jintegra.AutomationException automationException) {
      automationException.fillInStackTrace();
      throw automationException;
    }
  ...
  public String zz_toString  () throws java.io.IOException, com.linar.jintegra.AutomationException {
    try {
      return d_A4WBCD_DispatchProxy.zz_toString();
    } catch(com.linar.jintegra.AutomationException automationException) {
      automationException.fillInStackTrace();
      throw automationException;
    }
  ...
  public boolean zz_equals  (
    ...
    try {
      return d_A4WBCD_DispatchProxy.zz_equals(parameter0);
    } catch(com.linar.jintegra.AutomationException automationException) {
      automationException.fillInStackTrace();
      throw automationException;
    }
  ...
  public void zz_notify  () throws java.io.IOException, com.linar.jintegra.AutomationException {
    try {
      d_A4WBCD_DispatchProxy.zz_notify();
    } catch(com.linar.jintegra.AutomationException automationException) {
      automationException.fillInStackTrace();
      throw automationException;
    }
  ...
  public Object zz_getClass  () throws java.io.IOException, com.linar.jintegra.AutomationException {
    try {
      return d_A4WBCD_DispatchProxy.zz_getClass();
    } catch(com.linar.jintegra.AutomationException automationException) {
      automationException.fillInStackTrace();
      throw automationException;
    }
  ...
  public void zz_notifyAll  () throws java.io.IOException, com.linar.jintegra.AutomationException {
    try {
      d_A4WBCD_DispatchProxy.zz_notifyAll();
    } catch(com.linar.jintegra.AutomationException automationException) {
      automationException.fillInStackTrace();
      throw automationException;
    }
