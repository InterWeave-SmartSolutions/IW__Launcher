...
/**
 * Proxy for COM Interface 'A4WConstants_Dispatch'. Generated 18/10/2006 4:32:52 PM
 ...
 *   DontOverwrite = False
 */
public class A4WConstants_DispatchProxy extends com.linar.jintegra.Dispatch implements com.interweave.plugin.A4WEEADV.A4WConstants_Dispatch, java.io.Serializable {

  protected String getJintegraVersion() { return "2.6"; }

  static { com.interweave.plugin.A4WEEADV.JIntegraInit.init(); }

  public static final Class targetClass = A4WConstants_Dispatch.class;

  public A4WConstants_DispatchProxy(String CLSID, String host, AuthInfo authInfo) throws java.net.UnknownHostException, java.io.IOException{
    super(CLSID, A4WConstants_Dispatch.IID, host, authInfo);
  }

  /** For internal use only */
  public A4WConstants_DispatchProxy() {}

  public A4WConstants_DispatchProxy(Object obj) throws java.io.IOException {
    super(obj, A4WConstants_Dispatch.IID);
  }

  protected A4WConstants_DispatchProxy(Object obj, String iid) throws java.io.IOException {
    super(obj, iid);
  }

  protected A4WConstants_DispatchProxy(String CLSID, String iid, String host, AuthInfo authInfo) throws java.io.IOException {
  ...
  static {
    com.linar.jintegra.InterfaceDesc.add("55b8f109-b25d-43f1-ab78-c42bcefc4f25", com.interweave.plugin.A4WEEADV.A4WConstants_DispatchProxy.class, null, 0, null );
  }
}
