...
/**
 * Proxy for COM Interface 'A4WSizeString_Dispatch'. Generated 18/10/2006 4:32:53 PM
 ...
 *   DontOverwrite = False
 */
public class A4WSizeString_DispatchProxy extends com.linar.jintegra.Dispatch implements com.interweave.plugin.A4WEEADV.A4WSizeString_Dispatch, java.io.Serializable {

  protected String getJintegraVersion() { return "2.6"; }

  static { com.interweave.plugin.A4WEEADV.JIntegraInit.init(); }

  public static final Class targetClass = A4WSizeString_Dispatch.class;

  public A4WSizeString_DispatchProxy(String CLSID, String host, AuthInfo authInfo) throws java.net.UnknownHostException, java.io.IOException{
    super(CLSID, A4WSizeString_Dispatch.IID, host, authInfo);
  }

  /** For internal use only */
  public A4WSizeString_DispatchProxy() {}

  public A4WSizeString_DispatchProxy(Object obj) throws java.io.IOException {
    super(obj, A4WSizeString_Dispatch.IID);
  }

  protected A4WSizeString_DispatchProxy(Object obj, String iid) throws java.io.IOException {
    super(obj, iid);
  }

  protected A4WSizeString_DispatchProxy(String CLSID, String iid, String host, AuthInfo authInfo) throws java.io.IOException {
  ...
  public int getSize  () throws java.io.IOException, com.linar.jintegra.AutomationException{
    com.linar.jintegra.Variant[] parameters = {};
    return invoke("getSize", 100, 2, parameters).getI4();
  }
  ...
  public int getSize2  () throws java.io.IOException, com.linar.jintegra.AutomationException{
    com.linar.jintegra.Variant[] parameters = {};
    return invoke("getSize2", 105, 1, parameters).getI4();
  }
  ...
  public String getString  () throws java.io.IOException, com.linar.jintegra.AutomationException{
    com.linar.jintegra.Variant[] parameters = {};
    return invoke("getString", 107, 1, parameters).getBSTR();
  }
  ...
  public Object zz_getClass  () throws java.io.IOException, com.linar.jintegra.AutomationException{
    com.linar.jintegra.Variant[] parameters = {};
    return invoke("zz_getClass", 108, 1, parameters).getDISPATCH();
  }
  ...
  public void zz_notifyAll  () throws java.io.IOException, com.linar.jintegra.AutomationException{
    com.linar.jintegra.Variant[] parameters = {};
    invoke("zz_notifyAll", 109, 1, parameters);
    return;
  }
  ...
  public String getString2  () throws java.io.IOException, com.linar.jintegra.AutomationException{
    com.linar.jintegra.Variant[] parameters = {};
    return invoke("getString2", 110, 2, parameters).getBSTR();
  }
  ...
  static {
    com.linar.jintegra.InterfaceDesc.add("a47e5ab6-1c10-4362-a258-d014aefd2907", com.interweave.plugin.A4WEEADV.A4WSizeString_DispatchProxy.class, null, 0, null );
  }
}
