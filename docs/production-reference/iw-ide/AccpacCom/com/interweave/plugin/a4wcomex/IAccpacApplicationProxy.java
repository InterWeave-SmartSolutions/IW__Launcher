...
/**
 * Proxy for COM Interface 'IAccpacApplication'. Generated 02/10/2006 12:21:34 PM
 ...
 *   DontOverwrite = False
 */
public class IAccpacApplicationProxy extends com.linar.jintegra.Dispatch implements com.interweave.plugin.a4wcomex.IAccpacApplication, java.io.Serializable {

  protected String getJintegraVersion() { return "2.6"; }

  static { com.interweave.plugin.a4wcomex.JIntegraInit.init(); }

  public static final Class targetClass = IAccpacApplication.class;

  public IAccpacApplicationProxy(String CLSID, String host, AuthInfo authInfo) throws java.net.UnknownHostException, java.io.IOException{
    super(CLSID, IAccpacApplication.IID, host, authInfo);
  }

  /** For internal use only */
  public IAccpacApplicationProxy() {}

  public IAccpacApplicationProxy(Object obj) throws java.io.IOException {
    super(obj, IAccpacApplication.IID);
  }

  protected IAccpacApplicationProxy(Object obj, String iid) throws java.io.IOException {
    super(obj, iid);
  }

  protected IAccpacApplicationProxy(String CLSID, String iid, String host, AuthInfo authInfo) throws java.io.IOException {
  ...
  public String getPgmID  () throws java.io.IOException, com.linar.jintegra.AutomationException{
    ...
    vtblInvoke("getPgmID", 7, zz_parameters);
  ...
  public short getDataLevel  () throws java.io.IOException, com.linar.jintegra.AutomationException{
    short zz_retVal[] = { 0 };
    Object zz_parameters[] = { zz_retVal };
    vtblInvoke("getDataLevel", 8, zz_parameters);
    return zz_retVal[0];
  }
  ...
  public String getPgmVer  () throws java.io.IOException, com.linar.jintegra.AutomationException{
    String zz_retVal[] = { null };
    Object zz_parameters[] = { zz_retVal };
    vtblInvoke("getPgmVer", 9, zz_parameters);
    return (String)zz_retVal[0];
  }
  ...
  public String getSelector  () throws java.io.IOException, com.linar.jintegra.AutomationException{
    String zz_retVal[] = { null };
    Object zz_parameters[] = { zz_retVal };
    vtblInvoke("getSelector", 10, zz_parameters);
    return (String)zz_retVal[0];
  }
  ...
  public String getSequence  () throws java.io.IOException, com.linar.jintegra.AutomationException{
    String zz_retVal[] = { null };
    Object zz_parameters[] = { zz_retVal };
    vtblInvoke("getSequence", 11, zz_parameters);
    return (String)zz_retVal[0];
  }
  ...
  public boolean isInstalled  () throws java.io.IOException, com.linar.jintegra.AutomationException{
    ...
    Object zz_parameters[] = { zz_retVal };
    vtblInvoke("isInstalled", 12, zz_parameters);
    return zz_retVal[0];
  }
  ...
  static {
    com.linar.jintegra.InterfaceDesc.add("b5c56173-9214-11d3-9fbc-00c04f815d63", com.interweave.plugin.a4wcomex.IAccpacApplicationProxy.class, null, 7, new com.linar.jintegra.MemberDesc[] {
        new com.linar.jintegra.MemberDesc("getPgmID",
            new Class[] { },
            new com.linar.jintegra.Param[] { 
              new com.linar.jintegra.Param("pVal", 8, 20, 8, null, null) }),
        new com.linar.jintegra.MemberDesc("getDataLevel",
            new Class[] { },
            new com.linar.jintegra.Param[] { 
              new com.linar.jintegra.Param("pVal", 2, 20, 8, null, null) }),
        new com.linar.jintegra.MemberDesc("getPgmVer",
            new Class[] { },
            new com.linar.jintegra.Param[] { 
              new com.linar.jintegra.Param("pVal", 8, 20, 8, null, null) }),
        new com.linar.jintegra.MemberDesc("getSelector",
            new Class[] { },
            new com.linar.jintegra.Param[] { 
              new com.linar.jintegra.Param("pVal", 8, 20, 8, null, null) }),
        new com.linar.jintegra.MemberDesc("getSequence",
            new Class[] { },
            new com.linar.jintegra.Param[] { 
              new com.linar.jintegra.Param("pVal", 8, 20, 8, null, null) }),
        new com.linar.jintegra.MemberDesc("isInstalled",
            new Class[] { },
            new com.linar.jintegra.Param[] { 
