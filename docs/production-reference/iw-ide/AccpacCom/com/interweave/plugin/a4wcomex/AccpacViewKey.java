...
/**
 * COM Class 'AccpacViewKey'. Generated 02/10/2006 12:21:33 PM
 ...
 *   DontOverwrite = False
 */
public class AccpacViewKey implements com.linar.jintegra.RemoteObjRef, com.interweave.plugin.a4wcomex.IAccpacViewKey {

  private static final String CLSID = "f86a6c56-b7ce-11d2-9baa-00104b71eb3f";

  protected String getJintegraVersion() { return "2.6"; }

  // Interface delegates
  private com.interweave.plugin.a4wcomex.IAccpacViewKeyProxy d_IAccpacViewKeyProxy = null;

  /** Access this COM class's com.interweave.plugin.a4wcomex.IAccpacViewKey interface */
  public com.interweave.plugin.a4wcomex.IAccpacViewKey getAsIAccpacViewKey() { return d_IAccpacViewKeyProxy; }
   ...
   */
  public static AccpacViewKey getActiveObject() throws com.linar.jintegra.AutomationException, java.io.IOException {
    return new AccpacViewKey(com.linar.jintegra.Dispatch.getActiveObject(CLSID));
  }
   ...
   * @exception com.linar.jintegra.AutomationException If there was an error attaching to the instance.
   */
  public static AccpacViewKey bindUsingMoniker(String moniker) throws com.linar.jintegra.AutomationException, java.io.IOException {
    return new AccpacViewKey(com.linar.jintegra.Dispatch.bindUsingMoniker(moniker));
  }

  /** J-Integra for COM internal method */
  public com.linar.jintegra.Dispatch getJintegraDispatch() {  return d_IAccpacViewKeyProxy; }

  /**
   * Constructs a AccpacViewKey on the local host.
   ...
   */
  public AccpacViewKey() throws java.io.IOException, java.net.UnknownHostException {
    this("localhost");
  }

  /**
   * Construct a AccpacViewKey on specified host.
   * @param     host  the host on which the object should be created
   * @exception java.io.IOException if there are problems communicating via DCOM 
   * @exception java.net.UnknownHostException if the host can not be found 
   */
  public AccpacViewKey(String host) throws java.io.IOException, java.net.UnknownHostException {
    d_IAccpacViewKeyProxy = new com.interweave.plugin.a4wcomex.IAccpacViewKeyProxy(CLSID, host, null);
  }

  /**
   * Construct a AccpacViewKey using a reference to such an object returned from a COM server
   * @param     obj an object returned from a COM server
   * @exception java.io.IOException if there are problems communicating via DCOM 
   */
  public AccpacViewKey(Object obj) throws java.io.IOException {
    d_IAccpacViewKeyProxy = new com.interweave.plugin.a4wcomex.IAccpacViewKeyProxy(obj);
  }

  /**
   * Release a AccpacViewKey.
   */
  public void release() {
    com.linar.jintegra.Cleaner.release(d_IAccpacViewKeyProxy);
  }
  ...
  public Object getPropertyByName(String name) throws NoSuchFieldException, java.io.IOException, com.linar.jintegra.AutomationException {
    try {
      return d_IAccpacViewKeyProxy.getPropertyByName(name);
  ...
  public Object getPropertyByName(String name, Object rhs) throws NoSuchFieldException, java.io.IOException, com.linar.jintegra.AutomationException {
    try {
      return d_IAccpacViewKeyProxy.getPropertyByName(name, rhs);
    } catch(com.linar.jintegra.AutomationException automationException) {
      automationException.fillInStackTrace();
      throw automationException;
    } catch(NoSuchFieldException noSuchFieldException) {
  ...
  public Object invokeMethodByName(String name, Object[] parameters) throws NoSuchMethodException, java.io.IOException, com.linar.jintegra.AutomationException {
    return d_IAccpacViewKeyProxy.invokeMethodByName(name, parameters);
  }
  ...
  public Object invokeMethodByName(String name) throws NoSuchMethodException, java.io.IOException, com.linar.jintegra.AutomationException {
    return d_IAccpacViewKeyProxy.invokeMethodByName(name, new Object[]{});
  }
  ...
  public String getName  () throws java.io.IOException, com.linar.jintegra.AutomationException {
    try {
      return d_IAccpacViewKeyProxy.getName();
    } catch(com.linar.jintegra.AutomationException automationException) {
      automationException.fillInStackTrace();
      throw automationException;
    }
  ...
  public int getFieldCount  () throws java.io.IOException, com.linar.jintegra.AutomationException {
    try {
      return d_IAccpacViewKeyProxy.getFieldCount();
    } catch(com.linar.jintegra.AutomationException automationException) {
      automationException.fillInStackTrace();
      throw automationException;
    }
  ...
  public Object getFieldValues  () throws java.io.IOException, com.linar.jintegra.AutomationException {
    try {
      return d_IAccpacViewKeyProxy.getFieldValues();
    } catch(com.linar.jintegra.AutomationException automationException) {
      automationException.fillInStackTrace();
      throw automationException;
    }
  ...
  public void setFieldValues  (
    ...
    try {
      d_IAccpacViewKeyProxy.setFieldValues(pVal);
    } catch(com.linar.jintegra.AutomationException automationException) {
      automationException.fillInStackTrace();
      throw automationException;
    }
  ...
  public com.interweave.plugin.a4wcomex.IAccpacViewField getField  (
    ...
    try {
      return d_IAccpacViewKeyProxy.getField(index);
    } catch(com.linar.jintegra.AutomationException automationException) {
      automationException.fillInStackTrace();
      throw automationException;
    }
