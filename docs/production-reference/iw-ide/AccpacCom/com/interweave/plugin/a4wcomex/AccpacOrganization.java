...
/**
 * COM Class 'AccpacOrganization'. Generated 02/10/2006 12:21:34 PM
 ...
 * Description '<B>ACCPAC organization setup class</B>'
 *
 * Generator Options:
 *   AwtForOcxs = False
 ...
 *   DontOverwrite = False
 */
public class AccpacOrganization implements com.linar.jintegra.RemoteObjRef, com.interweave.plugin.a4wcomex.IAccpacOrganization {

  private static final String CLSID = "0aacfc46-c1d2-11d2-9bb4-00104b71eb3f";

  protected String getJintegraVersion() { return "2.6"; }

  // Interface delegates
  private com.interweave.plugin.a4wcomex.IAccpacOrganizationProxy d_IAccpacOrganizationProxy = null;

  /** Access this COM class's com.interweave.plugin.a4wcomex.IAccpacOrganization interface */
  public com.interweave.plugin.a4wcomex.IAccpacOrganization getAsIAccpacOrganization() { return d_IAccpacOrganizationProxy; }
   ...
   */
  public static AccpacOrganization getActiveObject() throws com.linar.jintegra.AutomationException, java.io.IOException {
    return new AccpacOrganization(com.linar.jintegra.Dispatch.getActiveObject(CLSID));
  }
   ...
   * @exception com.linar.jintegra.AutomationException If there was an error attaching to the instance.
   */
  public static AccpacOrganization bindUsingMoniker(String moniker) throws com.linar.jintegra.AutomationException, java.io.IOException {
    return new AccpacOrganization(com.linar.jintegra.Dispatch.bindUsingMoniker(moniker));
  }

  /** J-Integra for COM internal method */
  public com.linar.jintegra.Dispatch getJintegraDispatch() {  return d_IAccpacOrganizationProxy; }

  /**
   * Constructs a AccpacOrganization on the local host.
   ...
   */
  public AccpacOrganization() throws java.io.IOException, java.net.UnknownHostException {
    this("localhost");
  }

  /**
   * Construct a AccpacOrganization on specified host.
   * @param     host  the host on which the object should be created
   * @exception java.io.IOException if there are problems communicating via DCOM 
   * @exception java.net.UnknownHostException if the host can not be found 
   */
  public AccpacOrganization(String host) throws java.io.IOException, java.net.UnknownHostException {
    d_IAccpacOrganizationProxy = new com.interweave.plugin.a4wcomex.IAccpacOrganizationProxy(CLSID, host, null);
  }

  /**
   * Construct a AccpacOrganization using a reference to such an object returned from a COM server
   * @param     obj an object returned from a COM server
   * @exception java.io.IOException if there are problems communicating via DCOM 
   */
  public AccpacOrganization(Object obj) throws java.io.IOException {
    d_IAccpacOrganizationProxy = new com.interweave.plugin.a4wcomex.IAccpacOrganizationProxy(obj);
  }

  /**
   * Release a AccpacOrganization.
   */
  public void release() {
    com.linar.jintegra.Cleaner.release(d_IAccpacOrganizationProxy);
  }
  ...
  public Object getPropertyByName(String name) throws NoSuchFieldException, java.io.IOException, com.linar.jintegra.AutomationException {
    try {
      return d_IAccpacOrganizationProxy.getPropertyByName(name);
  ...
  public Object getPropertyByName(String name, Object rhs) throws NoSuchFieldException, java.io.IOException, com.linar.jintegra.AutomationException {
    try {
      return d_IAccpacOrganizationProxy.getPropertyByName(name, rhs);
    } catch(com.linar.jintegra.AutomationException automationException) {
      automationException.fillInStackTrace();
      throw automationException;
    } catch(NoSuchFieldException noSuchFieldException) {
  ...
  public Object invokeMethodByName(String name, Object[] parameters) throws NoSuchMethodException, java.io.IOException, com.linar.jintegra.AutomationException {
    return d_IAccpacOrganizationProxy.invokeMethodByName(name, parameters);
  }
  ...
  public Object invokeMethodByName(String name) throws NoSuchMethodException, java.io.IOException, com.linar.jintegra.AutomationException {
    return d_IAccpacOrganizationProxy.invokeMethodByName(name, new Object[]{});
  }
  ...
  public String getName  () throws java.io.IOException, com.linar.jintegra.AutomationException {
    try {
      return d_IAccpacOrganizationProxy.getName();
    } catch(com.linar.jintegra.AutomationException automationException) {
      automationException.fillInStackTrace();
      throw automationException;
    }
  ...
  public String getDatabaseID  () throws java.io.IOException, com.linar.jintegra.AutomationException {
    try {
      return d_IAccpacOrganizationProxy.getDatabaseID();
    } catch(com.linar.jintegra.AutomationException automationException) {
      automationException.fillInStackTrace();
      throw automationException;
    }
  ...
  public int getType  () throws java.io.IOException, com.linar.jintegra.AutomationException {
    try {
      return d_IAccpacOrganizationProxy.getType();
    } catch(com.linar.jintegra.AutomationException automationException) {
      automationException.fillInStackTrace();
      throw automationException;
    }
  ...
  public String getSystemDatabaseID  () throws java.io.IOException, com.linar.jintegra.AutomationException {
    try {
      return d_IAccpacOrganizationProxy.getSystemDatabaseID();
    } catch(com.linar.jintegra.AutomationException automationException) {
      automationException.fillInStackTrace();
      throw automationException;
    }
  ...
  public void getOrgInfo  (
    ...
    try {
      d_IAccpacOrganizationProxy.getOrgInfo(databaseID,name,systemDatabaseID,type,secEnabled);
    } catch(com.linar.jintegra.AutomationException automationException) {
      automationException.fillInStackTrace();
      throw automationException;
    }
