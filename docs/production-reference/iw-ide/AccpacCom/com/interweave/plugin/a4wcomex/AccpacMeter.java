...
/**
 * COM Class 'AccpacMeter'. Generated 02/10/2006 12:21:34 PM
 ...
 *   DontOverwrite = False
 */
public class AccpacMeter implements com.linar.jintegra.RemoteObjRef, com.interweave.plugin.a4wcomex.IAccpacMeter {

  private static final String CLSID = "5e4aa421-1a23-11d5-a8c7-00105a0af272";

  protected String getJintegraVersion() { return "2.6"; }

  // Interface delegates
  private com.interweave.plugin.a4wcomex.IAccpacMeterProxy d_IAccpacMeterProxy = null;

  /** Access this COM class's com.interweave.plugin.a4wcomex.IAccpacMeter interface */
  public com.interweave.plugin.a4wcomex.IAccpacMeter getAsIAccpacMeter() { return d_IAccpacMeterProxy; }
   ...
   */
  public static AccpacMeter getActiveObject() throws com.linar.jintegra.AutomationException, java.io.IOException {
    return new AccpacMeter(com.linar.jintegra.Dispatch.getActiveObject(CLSID));
  }
   ...
   * @exception com.linar.jintegra.AutomationException If there was an error attaching to the instance.
   */
  public static AccpacMeter bindUsingMoniker(String moniker) throws com.linar.jintegra.AutomationException, java.io.IOException {
    return new AccpacMeter(com.linar.jintegra.Dispatch.bindUsingMoniker(moniker));
  }

  /** J-Integra for COM internal method */
  public com.linar.jintegra.Dispatch getJintegraDispatch() {  return d_IAccpacMeterProxy; }

  /**
   * Constructs a AccpacMeter on the local host.
   ...
   */
  public AccpacMeter() throws java.io.IOException, java.net.UnknownHostException {
    this("localhost");
  }

  /**
   * Construct a AccpacMeter on specified host.
   * @param     host  the host on which the object should be created
   * @exception java.io.IOException if there are problems communicating via DCOM 
   * @exception java.net.UnknownHostException if the host can not be found 
   */
  public AccpacMeter(String host) throws java.io.IOException, java.net.UnknownHostException {
    d_IAccpacMeterProxy = new com.interweave.plugin.a4wcomex.IAccpacMeterProxy(CLSID, host, null);
  }

  /**
   * Construct a AccpacMeter using a reference to such an object returned from a COM server
   * @param     obj an object returned from a COM server
   * @exception java.io.IOException if there are problems communicating via DCOM 
   */
  public AccpacMeter(Object obj) throws java.io.IOException {
    d_IAccpacMeterProxy = new com.interweave.plugin.a4wcomex.IAccpacMeterProxy(obj);
  }

  /**
   * Release a AccpacMeter.
   */
  public void release() {
    com.linar.jintegra.Cleaner.release(d_IAccpacMeterProxy);
  }
  ...
  public Object getPropertyByName(String name) throws NoSuchFieldException, java.io.IOException, com.linar.jintegra.AutomationException {
    try {
      return d_IAccpacMeterProxy.getPropertyByName(name);
  ...
  public Object getPropertyByName(String name, Object rhs) throws NoSuchFieldException, java.io.IOException, com.linar.jintegra.AutomationException {
    try {
      return d_IAccpacMeterProxy.getPropertyByName(name, rhs);
    } catch(com.linar.jintegra.AutomationException automationException) {
      automationException.fillInStackTrace();
      throw automationException;
    } catch(NoSuchFieldException noSuchFieldException) {
  ...
  public Object invokeMethodByName(String name, Object[] parameters) throws NoSuchMethodException, java.io.IOException, com.linar.jintegra.AutomationException {
    return d_IAccpacMeterProxy.invokeMethodByName(name, parameters);
  }
  ...
  public Object invokeMethodByName(String name) throws NoSuchMethodException, java.io.IOException, com.linar.jintegra.AutomationException {
    return d_IAccpacMeterProxy.invokeMethodByName(name, new Object[]{});
  }
  ...
  public boolean isRunning  () throws java.io.IOException, com.linar.jintegra.AutomationException {
    try {
      return d_IAccpacMeterProxy.isRunning();
    } catch(com.linar.jintegra.AutomationException automationException) {
      automationException.fillInStackTrace();
      throw automationException;
    }
  ...
  public String getLabel  () throws java.io.IOException, com.linar.jintegra.AutomationException {
    try {
      return d_IAccpacMeterProxy.getLabel();
    } catch(com.linar.jintegra.AutomationException automationException) {
      automationException.fillInStackTrace();
      throw automationException;
    }
  ...
  public int getPercent  () throws java.io.IOException, com.linar.jintegra.AutomationException {
    try {
      return d_IAccpacMeterProxy.getPercent();
    } catch(com.linar.jintegra.AutomationException automationException) {
      automationException.fillInStackTrace();
      throw automationException;
    }
  ...
  public String getCaption  () throws java.io.IOException, com.linar.jintegra.AutomationException {
    try {
      return d_IAccpacMeterProxy.getCaption();
    } catch(com.linar.jintegra.AutomationException automationException) {
      automationException.fillInStackTrace();
      throw automationException;
    }
  ...
  public boolean isShowGauge  () throws java.io.IOException, com.linar.jintegra.AutomationException {
    try {
      return d_IAccpacMeterProxy.isShowGauge();
    } catch(com.linar.jintegra.AutomationException automationException) {
      automationException.fillInStackTrace();
      throw automationException;
    }
  ...
  public boolean isShowCancel  () throws java.io.IOException, com.linar.jintegra.AutomationException {
    try {
      return d_IAccpacMeterProxy.isShowCancel();
    } catch(com.linar.jintegra.AutomationException automationException) {
      automationException.fillInStackTrace();
      throw automationException;
    }
  ...
  public void getCurrentStatus  (
    ...
    try {
      d_IAccpacMeterProxy.getCurrentStatus(isRunning,pLabel,pPercent);
    } catch(com.linar.jintegra.AutomationException automationException) {
      automationException.fillInStackTrace();
      throw automationException;
    }
