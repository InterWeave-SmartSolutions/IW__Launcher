...
/**
 * COM Class 'AccpacCurrencyRate'. Generated 02/10/2006 12:21:34 PM
 ...
 * Description '<B>Exchange rate information class</B>'
 *
 * Generator Options:
 *   AwtForOcxs = False
 ...
 *   DontOverwrite = False
 */
public class AccpacCurrencyRate implements com.linar.jintegra.RemoteObjRef, com.interweave.plugin.a4wcomex.IAccpacCurrencyRate {

  private static final String CLSID = "ef51dc24-9eae-11d3-9fcd-00c04f815d63";

  protected String getJintegraVersion() { return "2.6"; }

  // Interface delegates
  private com.interweave.plugin.a4wcomex.IAccpacCurrencyRateProxy d_IAccpacCurrencyRateProxy = null;

  /** Access this COM class's com.interweave.plugin.a4wcomex.IAccpacCurrencyRate interface */
  public com.interweave.plugin.a4wcomex.IAccpacCurrencyRate getAsIAccpacCurrencyRate() { return d_IAccpacCurrencyRateProxy; }
   ...
   */
  public static AccpacCurrencyRate getActiveObject() throws com.linar.jintegra.AutomationException, java.io.IOException {
    return new AccpacCurrencyRate(com.linar.jintegra.Dispatch.getActiveObject(CLSID));
  }
   ...
   * @exception com.linar.jintegra.AutomationException If there was an error attaching to the instance.
   */
  public static AccpacCurrencyRate bindUsingMoniker(String moniker) throws com.linar.jintegra.AutomationException, java.io.IOException {
    return new AccpacCurrencyRate(com.linar.jintegra.Dispatch.bindUsingMoniker(moniker));
  }

  /** J-Integra for COM internal method */
  public com.linar.jintegra.Dispatch getJintegraDispatch() {  return d_IAccpacCurrencyRateProxy; }

  /**
   * Constructs a AccpacCurrencyRate on the local host.
   ...
   */
  public AccpacCurrencyRate() throws java.io.IOException, java.net.UnknownHostException {
    this("localhost");
  }

  /**
   * Construct a AccpacCurrencyRate on specified host.
   * @param     host  the host on which the object should be created
   * @exception java.io.IOException if there are problems communicating via DCOM 
   * @exception java.net.UnknownHostException if the host can not be found 
   */
  public AccpacCurrencyRate(String host) throws java.io.IOException, java.net.UnknownHostException {
    d_IAccpacCurrencyRateProxy = new com.interweave.plugin.a4wcomex.IAccpacCurrencyRateProxy(CLSID, host, null);
  }

  /**
   * Construct a AccpacCurrencyRate using a reference to such an object returned from a COM server
   * @param     obj an object returned from a COM server
   * @exception java.io.IOException if there are problems communicating via DCOM 
   */
  public AccpacCurrencyRate(Object obj) throws java.io.IOException {
    d_IAccpacCurrencyRateProxy = new com.interweave.plugin.a4wcomex.IAccpacCurrencyRateProxy(obj);
  }

  /**
   * Release a AccpacCurrencyRate.
   */
  public void release() {
    com.linar.jintegra.Cleaner.release(d_IAccpacCurrencyRateProxy);
  }
  ...
  public Object getPropertyByName(String name) throws NoSuchFieldException, java.io.IOException, com.linar.jintegra.AutomationException {
    try {
      return d_IAccpacCurrencyRateProxy.getPropertyByName(name);
  ...
  public Object getPropertyByName(String name, Object rhs) throws NoSuchFieldException, java.io.IOException, com.linar.jintegra.AutomationException {
    try {
      return d_IAccpacCurrencyRateProxy.getPropertyByName(name, rhs);
    } catch(com.linar.jintegra.AutomationException automationException) {
      automationException.fillInStackTrace();
      throw automationException;
    } catch(NoSuchFieldException noSuchFieldException) {
  ...
  public Object invokeMethodByName(String name, Object[] parameters) throws NoSuchMethodException, java.io.IOException, com.linar.jintegra.AutomationException {
    return d_IAccpacCurrencyRateProxy.invokeMethodByName(name, parameters);
  }
  ...
  public Object invokeMethodByName(String name) throws NoSuchMethodException, java.io.IOException, com.linar.jintegra.AutomationException {
    return d_IAccpacCurrencyRateProxy.invokeMethodByName(name, new Object[]{});
  }
  ...
  public Object getRate  () throws java.io.IOException, com.linar.jintegra.AutomationException {
    try {
      return d_IAccpacCurrencyRateProxy.getRate();
    } catch(com.linar.jintegra.AutomationException automationException) {
      automationException.fillInStackTrace();
      throw automationException;
    }
  ...
  public Object getSpread  () throws java.io.IOException, com.linar.jintegra.AutomationException {
    try {
      return d_IAccpacCurrencyRateProxy.getSpread();
    } catch(com.linar.jintegra.AutomationException automationException) {
      automationException.fillInStackTrace();
      throw automationException;
    }
  ...
  public int getDateMatch  () throws java.io.IOException, com.linar.jintegra.AutomationException {
    try {
      return d_IAccpacCurrencyRateProxy.getDateMatch();
    } catch(com.linar.jintegra.AutomationException automationException) {
      automationException.fillInStackTrace();
      throw automationException;
    }
  ...
  public int getRateOperator  () throws java.io.IOException, com.linar.jintegra.AutomationException {
    try {
      return d_IAccpacCurrencyRateProxy.getRateOperator();
    } catch(com.linar.jintegra.AutomationException automationException) {
      automationException.fillInStackTrace();
      throw automationException;
    }
  ...
  public java.util.Date getRateDate  () throws java.io.IOException, com.linar.jintegra.AutomationException {
    try {
      return d_IAccpacCurrencyRateProxy.getRateDate();
    } catch(com.linar.jintegra.AutomationException automationException) {
      automationException.fillInStackTrace();
      throw automationException;
    }
  ...
  public String getHomeCurrency  () throws java.io.IOException, com.linar.jintegra.AutomationException {
    try {
      return d_IAccpacCurrencyRateProxy.getHomeCurrency();
    } catch(com.linar.jintegra.AutomationException automationException) {
      automationException.fillInStackTrace();
      throw automationException;
    }
  ...
  public String getRateType  () throws java.io.IOException, com.linar.jintegra.AutomationException {
    try {
      return d_IAccpacCurrencyRateProxy.getRateType();
    } catch(com.linar.jintegra.AutomationException automationException) {
      automationException.fillInStackTrace();
      throw automationException;
    }
  ...
  public String getSourceCurrency  () throws java.io.IOException, com.linar.jintegra.AutomationException {
    try {
      return d_IAccpacCurrencyRateProxy.getSourceCurrency();
    } catch(com.linar.jintegra.AutomationException automationException) {
      automationException.fillInStackTrace();
      throw automationException;
    }
