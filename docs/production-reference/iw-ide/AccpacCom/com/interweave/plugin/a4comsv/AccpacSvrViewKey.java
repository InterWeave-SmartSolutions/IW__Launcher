...
/**
 * COM Class 'AccpacSvrViewKey'. Generated 12/10/2006 12:40:14 PM
 ...
 * Description '<B>View key class</B>'
 *
 * Generator Options:
 *   AwtForOcxs = False
 ...
 *   DontOverwrite = False
 */
public class AccpacSvrViewKey implements com.linar.jintegra.RemoteObjRef, com.interweave.plugin.a4comsv.IAccpacSvrViewKey {

  private static final String CLSID = "091b52dd-d447-4cbe-b115-66f15e78d39f";

  protected String getJintegraVersion() { return "2.6"; }

  // Interface delegates
  private com.interweave.plugin.a4comsv.IAccpacSvrViewKeyProxy d_IAccpacSvrViewKeyProxy = null;

  /** Access this COM class's com.interweave.plugin.a4comsv.IAccpacSvrViewKey interface */
  public com.interweave.plugin.a4comsv.IAccpacSvrViewKey getAsIAccpacSvrViewKey() { return d_IAccpacSvrViewKeyProxy; }
   ...
   */
  public static AccpacSvrViewKey getActiveObject() throws com.linar.jintegra.AutomationException, java.io.IOException {
    return new AccpacSvrViewKey(com.linar.jintegra.Dispatch.getActiveObject(CLSID));
  }
   ...
   * @exception com.linar.jintegra.AutomationException If there was an error attaching to the instance.
   */
  public static AccpacSvrViewKey bindUsingMoniker(String moniker) throws com.linar.jintegra.AutomationException, java.io.IOException {
    return new AccpacSvrViewKey(com.linar.jintegra.Dispatch.bindUsingMoniker(moniker));
  }

  /** J-Integra for COM internal method */
  public com.linar.jintegra.Dispatch getJintegraDispatch() {  return d_IAccpacSvrViewKeyProxy; }

  /**
   * Constructs a AccpacSvrViewKey on the local host.
   ...
   */
  public AccpacSvrViewKey() throws java.io.IOException, java.net.UnknownHostException {
    this("localhost");
  }

  /**
   * Construct a AccpacSvrViewKey on specified host.
   * @param     host  the host on which the object should be created
   * @exception java.io.IOException if there are problems communicating via DCOM 
   * @exception java.net.UnknownHostException if the host can not be found 
   */
  public AccpacSvrViewKey(String host) throws java.io.IOException, java.net.UnknownHostException {
    d_IAccpacSvrViewKeyProxy = new com.interweave.plugin.a4comsv.IAccpacSvrViewKeyProxy(CLSID, host, null);
  }

  /**
   * Construct a AccpacSvrViewKey using a reference to such an object returned from a COM server
   * @param     obj an object returned from a COM server
   * @exception java.io.IOException if there are problems communicating via DCOM 
   */
  public AccpacSvrViewKey(Object obj) throws java.io.IOException {
    d_IAccpacSvrViewKeyProxy = new com.interweave.plugin.a4comsv.IAccpacSvrViewKeyProxy(obj);
  }

  /**
   * Release a AccpacSvrViewKey.
   */
  public void release() {
    com.linar.jintegra.Cleaner.release(d_IAccpacSvrViewKeyProxy);
  }
  ...
  public Object getPropertyByName(String name) throws NoSuchFieldException, java.io.IOException, com.linar.jintegra.AutomationException {
    try {
      return d_IAccpacSvrViewKeyProxy.getPropertyByName(name);
  ...
  public Object getPropertyByName(String name, Object rhs) throws NoSuchFieldException, java.io.IOException, com.linar.jintegra.AutomationException {
    try {
      return d_IAccpacSvrViewKeyProxy.getPropertyByName(name, rhs);
    } catch(com.linar.jintegra.AutomationException automationException) {
      automationException.fillInStackTrace();
      throw automationException;
    } catch(NoSuchFieldException noSuchFieldException) {
  ...
  public Object invokeMethodByName(String name, Object[] parameters) throws NoSuchMethodException, java.io.IOException, com.linar.jintegra.AutomationException {
    return d_IAccpacSvrViewKeyProxy.invokeMethodByName(name, parameters);
  }
  ...
  public Object invokeMethodByName(String name) throws NoSuchMethodException, java.io.IOException, com.linar.jintegra.AutomationException {
    return d_IAccpacSvrViewKeyProxy.invokeMethodByName(name, new Object[]{});
  }
  ...
  public String getName  () throws java.io.IOException, com.linar.jintegra.AutomationException {
    try {
      return d_IAccpacSvrViewKeyProxy.getName();
    } catch(com.linar.jintegra.AutomationException automationException) {
      automationException.fillInStackTrace();
      throw automationException;
    }
  ...
  public int getFieldCount  () throws java.io.IOException, com.linar.jintegra.AutomationException {
    try {
      return d_IAccpacSvrViewKeyProxy.getFieldCount();
    } catch(com.linar.jintegra.AutomationException automationException) {
      automationException.fillInStackTrace();
      throw automationException;
    }
  ...
  public Object getFieldValues  () throws java.io.IOException, com.linar.jintegra.AutomationException {
    try {
      return d_IAccpacSvrViewKeyProxy.getFieldValues();
    } catch(com.linar.jintegra.AutomationException automationException) {
      automationException.fillInStackTrace();
      throw automationException;
    }
  ...
  public void setFieldValues  (
    ...
    try {
      d_IAccpacSvrViewKeyProxy.setFieldValues(pVal);
    } catch(com.linar.jintegra.AutomationException automationException) {
      automationException.fillInStackTrace();
      throw automationException;
    }
  ...
  public com.interweave.plugin.a4comsv.IAccpacSvrViewField getField  (
    ...
    try {
      return d_IAccpacSvrViewKeyProxy.getField(index);
    } catch(com.linar.jintegra.AutomationException automationException) {
      automationException.fillInStackTrace();
      throw automationException;
    }
  ...
  public void getFieldsInfo  (
    ...
    try {
      d_IAccpacSvrViewKeyProxy.getFieldsInfo(count,fieldIDs);
    } catch(com.linar.jintegra.AutomationException automationException) {
      automationException.fillInStackTrace();
      throw automationException;
    }
