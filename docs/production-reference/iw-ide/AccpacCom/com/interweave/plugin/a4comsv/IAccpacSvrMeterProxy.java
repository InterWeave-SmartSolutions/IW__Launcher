...
/**
 * Proxy for COM Interface 'IAccpacSvrMeter'. Generated 12/10/2006 12:40:15 PM
 ...
 *   DontOverwrite = False
 */
public class IAccpacSvrMeterProxy extends com.linar.jintegra.Dispatch implements com.interweave.plugin.a4comsv.IAccpacSvrMeter, java.io.Serializable {

  protected String getJintegraVersion() { return "2.6"; }

  static { com.interweave.plugin.a4comsv.JIntegraInit.init(); }

  public static final Class targetClass = IAccpacSvrMeter.class;

  public IAccpacSvrMeterProxy(String CLSID, String host, AuthInfo authInfo) throws java.net.UnknownHostException, java.io.IOException{
    super(CLSID, IAccpacSvrMeter.IID, host, authInfo);
  }

  /** For internal use only */
  public IAccpacSvrMeterProxy() {}

  public IAccpacSvrMeterProxy(Object obj) throws java.io.IOException {
    super(obj, IAccpacSvrMeter.IID);
  }

  protected IAccpacSvrMeterProxy(Object obj, String iid) throws java.io.IOException {
    super(obj, iid);
  }

  protected IAccpacSvrMeterProxy(String CLSID, String iid, String host, AuthInfo authInfo) throws java.io.IOException {
  ...
  static {
    com.linar.jintegra.InterfaceDesc.add("78962ea6-91f0-41df-be40-e885da6b7dd9", com.interweave.plugin.a4comsv.IAccpacSvrMeterProxy.class, null, 7, new com.linar.jintegra.MemberDesc[] {
