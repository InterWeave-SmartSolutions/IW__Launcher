 ...
 *   DontOverwrite = False
 */
public class xapiField implements com.linar.jintegra.RemoteObjRef, com.interweave.plugin.A4WCOM.IxapiField {

  private static final String CLSID = "48ef43c5-97f9-11d1-b5be-0060083b07c8";

  protected String getJintegraVersion() { return "2.6"; }

  // Interface delegates
  private com.interweave.plugin.A4WCOM.IxapiFieldProxy d_IxapiFieldProxy = null;

  /** Access this COM class's com.interweave.plugin.A4WCOM.IxapiField interface */
  public com.interweave.plugin.A4WCOM.IxapiField getAsIxapiField() { return d_IxapiFieldProxy; }
   ...
   */
  public static xapiField getActiveObject() throws com.linar.jintegra.AutomationException, java.io.IOException {
    return new xapiField(com.linar.jintegra.Dispatch.getActiveObject(CLSID));
  }
   ...
   * @exception com.linar.jintegra.AutomationException If there was an error attaching to the instance.
   */
  public static xapiField bindUsingMoniker(String moniker) throws com.linar.jintegra.AutomationException, java.io.IOException {
    return new xapiField(com.linar.jintegra.Dispatch.bindUsingMoniker(moniker));
  }

  /** J-Integra for COM internal method */
  public com.linar.jintegra.Dispatch getJintegraDispatch() {  return d_IxapiFieldProxy; }

  /**
   * Constructs a xapiField on the local host.
   ...
   */
  public xapiField() throws java.io.IOException, java.net.UnknownHostException {
    this("localhost");
  }

  /**
   * Construct a xapiField on specified host.
   * @param     host  the host on which the object should be created
   * @exception java.io.IOException if there are problems communicating via DCOM 
   * @exception java.net.UnknownHostException if the host can not be found 
   */
  public xapiField(String host) throws java.io.IOException, java.net.UnknownHostException {
    d_IxapiFieldProxy = new com.interweave.plugin.A4WCOM.IxapiFieldProxy(CLSID, host, null);
  }

  /**
   * Construct a xapiField using a reference to such an object returned from a COM server
   * @param     obj an object returned from a COM server
   * @exception java.io.IOException if there are problems communicating via DCOM 
   */
  public xapiField(Object obj) throws java.io.IOException {
    d_IxapiFieldProxy = new com.interweave.plugin.A4WCOM.IxapiFieldProxy(obj);
  }
   ...
   */
  public void release() {
    com.linar.jintegra.Cleaner.release(d_IxapiFieldProxy);
  }
  ...
  public Object getPropertyByName(String name) throws NoSuchFieldException, java.io.IOException, com.linar.jintegra.AutomationException {
    try {
      return d_IxapiFieldProxy.getPropertyByName(name);
  ...
  public Object getPropertyByName(String name, Object rhs) throws NoSuchFieldException, java.io.IOException, com.linar.jintegra.AutomationException {
    try {
      return d_IxapiFieldProxy.getPropertyByName(name, rhs);
    } catch(com.linar.jintegra.AutomationException automationException) {
      automationException.fillInStackTrace();
      throw automationException;
    } catch(NoSuchFieldException noSuchFieldException) {
  ...
  public Object invokeMethodByName(String name, Object[] parameters) throws NoSuchMethodException, java.io.IOException, com.linar.jintegra.AutomationException {
    return d_IxapiFieldProxy.invokeMethodByName(name, parameters);
  }
  ...
  public Object invokeMethodByName(String name) throws NoSuchMethodException, java.io.IOException, com.linar.jintegra.AutomationException {
    return d_IxapiFieldProxy.invokeMethodByName(name, new Object[]{});
  }
  ...
  public Object getValue  () throws java.io.IOException, com.linar.jintegra.AutomationException {
    try {
      return d_IxapiFieldProxy.getValue();
    } catch(com.linar.jintegra.AutomationException automationException) {
      automationException.fillInStackTrace();
      throw automationException;
    }
  ...
  public void setValue  (
    ...
    try {
      d_IxapiFieldProxy.setValue(pVal);
    } catch(com.linar.jintegra.AutomationException automationException) {
      automationException.fillInStackTrace();
      throw automationException;
    }
  ...
  public String getName  () throws java.io.IOException, com.linar.jintegra.AutomationException {
    try {
      return d_IxapiFieldProxy.getName();
    } catch(com.linar.jintegra.AutomationException automationException) {
      automationException.fillInStackTrace();
      throw automationException;
    }
  ...
  public String getDescription  () throws java.io.IOException, com.linar.jintegra.AutomationException {
    try {
      return d_IxapiFieldProxy.getDescription();
    } catch(com.linar.jintegra.AutomationException automationException) {
      automationException.fillInStackTrace();
      throw automationException;
    }
  ...
  public int getAttributes  () throws java.io.IOException, com.linar.jintegra.AutomationException {
    try {
      return d_IxapiFieldProxy.getAttributes();
    } catch(com.linar.jintegra.AutomationException automationException) {
      automationException.fillInStackTrace();
      throw automationException;
    }
  ...
  public int getType  () throws java.io.IOException, com.linar.jintegra.AutomationException {
    try {
      return d_IxapiFieldProxy.getType();
    } catch(com.linar.jintegra.AutomationException automationException) {
      automationException.fillInStackTrace();
      throw automationException;
    }
  ...
  public int getSize  () throws java.io.IOException, com.linar.jintegra.AutomationException {
    try {
      return d_IxapiFieldProxy.getSize();
    } catch(com.linar.jintegra.AutomationException automationException) {
      automationException.fillInStackTrace();
      throw automationException;
    }
  ...
  public int getPrecision  () throws java.io.IOException, com.linar.jintegra.AutomationException {
    try {
      return d_IxapiFieldProxy.getPrecision();
    } catch(com.linar.jintegra.AutomationException automationException) {
      automationException.fillInStackTrace();
      throw automationException;
    }
  ...
  public int getStyle  () throws java.io.IOException, com.linar.jintegra.AutomationException {
    try {
      return d_IxapiFieldProxy.getStyle();
    } catch(com.linar.jintegra.AutomationException automationException) {
      automationException.fillInStackTrace();
      throw automationException;
    }
  ...
  public int getPresentationType  () throws java.io.IOException, com.linar.jintegra.AutomationException {
    try {
      return d_IxapiFieldProxy.getPresentationType();
    } catch(com.linar.jintegra.AutomationException automationException) {
      automationException.fillInStackTrace();
      throw automationException;
    }
  ...
  public String getPresentationMask  () throws java.io.IOException, com.linar.jintegra.AutomationException {
    try {
      return d_IxapiFieldProxy.getPresentationMask();
    } catch(com.linar.jintegra.AutomationException automationException) {
      automationException.fillInStackTrace();
      throw automationException;
    }
  ...
  public void putWithoutVerification  (
    ...
    try {
      d_IxapiFieldProxy.putWithoutVerification(newVal);
    } catch(com.linar.jintegra.AutomationException automationException) {
      automationException.fillInStackTrace();
      throw automationException;
    }
  ...
  public com.interweave.plugin.A4WCOM.IxapiFieldPresentationStrings getPresentationStrings  () throws java.io.IOException, com.linar.jintegra.AutomationException {
    try {
      return d_IxapiFieldProxy.getPresentationStrings();
    } catch(com.linar.jintegra.AutomationException automationException) {
      automationException.fillInStackTrace();
      throw automationException;
    }
  ...
  public String getViewName  () throws java.io.IOException, com.linar.jintegra.AutomationException {
    try {
      return d_IxapiFieldProxy.getViewName();
    } catch(com.linar.jintegra.AutomationException automationException) {
      automationException.fillInStackTrace();
      throw automationException;
    }
