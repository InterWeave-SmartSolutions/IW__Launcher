...
/**
 * Proxy for COM Interface 'IxapiCurrencyTable'. Generated 06/10/2006 6:20:01 PM
 ...
 *   DontOverwrite = False
 */
public class IxapiCurrencyTableProxy extends com.linar.jintegra.Dispatch implements com.interweave.plugin.A4WCOM.IxapiCurrencyTable, java.io.Serializable {

  protected String getJintegraVersion() { return "2.6"; }

  static { com.interweave.plugin.A4WCOM.JIntegraInit.init(); }

  public static final Class targetClass = IxapiCurrencyTable.class;

  public IxapiCurrencyTableProxy(String CLSID, String host, AuthInfo authInfo) throws java.net.UnknownHostException, java.io.IOException{
    super(CLSID, IxapiCurrencyTable.IID, host, authInfo);
  }

  /** For internal use only */
  public IxapiCurrencyTableProxy() {}

  public IxapiCurrencyTableProxy(Object obj) throws java.io.IOException {
    super(obj, IxapiCurrencyTable.IID);
  }

  protected IxapiCurrencyTableProxy(Object obj, String iid) throws java.io.IOException {
    super(obj, iid);
  }

  protected IxapiCurrencyTableProxy(String CLSID, String iid, String host, AuthInfo authInfo) throws java.io.IOException {
  ...
  public String getSourceOfRates  () throws java.io.IOException, com.linar.jintegra.AutomationException{
    String zz_retVal[] = { null };
    Object zz_parameters[] = { zz_retVal };
    vtblInvoke("getSourceOfRates", 12, zz_parameters);
    return (String)zz_retVal[0];
  }
  ...
  public java.util.Date getAudDateTime  () throws java.io.IOException, com.linar.jintegra.AutomationException{
    ...
    Object zz_parameters[] = { zz_retVal };
    vtblInvoke("getAudDateTime", 13, zz_parameters);
  ...
  static {
    com.linar.jintegra.InterfaceDesc.add("26fb1744-9110-11d1-b5b4-0060083b07c8", com.interweave.plugin.A4WCOM.IxapiCurrencyTableProxy.class, null, 7, new com.linar.jintegra.MemberDesc[] {
        ...
        new com.linar.jintegra.MemberDesc("getDescription",
            ...
            new com.linar.jintegra.Param[] { 
              new com.linar.jintegra.Param("pVal", 8, 20, 8, null, null) }),
        new com.linar.jintegra.MemberDesc("getSourceOfRates",
            new Class[] { },
            new com.linar.jintegra.Param[] { 
              new com.linar.jintegra.Param("pVal", 8, 20, 8, null, null) }),
