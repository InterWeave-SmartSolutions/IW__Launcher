...
- **Database Schema**: `scripts/sql/MONITORING_MIGRATION_README.md`
...
- **Schema Migration**: `scripts/sql/005_monitoring_schema.sql`
- **Configuration File**: `WEB-INF/monitoring.properties`
- **Test Data Generator**: `scripts/sql/monitoring_test_data.sql`
