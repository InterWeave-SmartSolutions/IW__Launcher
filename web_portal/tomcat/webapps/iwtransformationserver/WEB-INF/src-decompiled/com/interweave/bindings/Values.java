...
implements Element {
    ...
    public static Values unmarshal(InputStream in) throws UnmarshalException {
        return Values.unmarshal(XMLScanner.open((InputStream)in));
    }

    public static Values unmarshal(XMLScanner xs) throws UnmarshalException {
        return Values.unmarshal(xs, Values.newDispatcher());
    }

    public static Values unmarshal(XMLScanner xs, Dispatcher d) throws UnmarshalException {
        return (Values)d.unmarshal(xs, Values.class);
    }
    ...
    public boolean equals(Object ob) {
        ...
        if (!(ob instanceof Values)) {
            return false;
        }
        Values tob = (Values)((Object)ob);
        if (this._Parameter != null) {
