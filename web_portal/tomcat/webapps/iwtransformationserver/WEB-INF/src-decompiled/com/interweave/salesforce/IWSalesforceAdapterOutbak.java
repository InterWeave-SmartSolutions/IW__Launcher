...
public class IWSalesforceAdapterOutbak
        ...
        if (access != null) {
            ...
            if (values != null) {
                for (Parameter param : values.getParameter()) {
                    ...
                    if (type == null || type == "" || type.compareToIgnoreCase("TransformIn") == 0 || type.compareToIgnoreCase("TransformPackageOut") == 0 || type.compareToIgnoreCase("TransformPackageOutEscape") == 0) continue;
            ...
            if (strTransformIn != null) {
                ...
                this.SOAPMessage = this.fileToString("message.xml");
            }
