...
public class SequenceElementIndirectParameter
extends BaseParameter {
    ...
    SequenceElementIndirectParameter(SoapRequest soapRequest, String aParamname, String aNamespaceURI, String aType, String aRefType, String aMinOccurs, String aMaxOccurs, String aNillable) {
        ...
        try {
            ...
            String[] names = parser.getWsdlXPathAttributeArray("//complexType[@name='" + aRefType + "']/sequence/element/@name");
            this.sequence = new Parameter[names.length];
            int i = 0;
            while (i < names.length) {
                String sName = names[i];
                String typeXPath = "//complexType[@name='" + aRefType + "']/sequence/element[@name='" + sName + "']";
