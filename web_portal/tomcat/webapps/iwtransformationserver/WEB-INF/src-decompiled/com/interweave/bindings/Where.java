...
implements Element {
    ...
    public static Where unmarshal(InputStream in) throws UnmarshalException {
        return Where.unmarshal(XMLScanner.open((InputStream)in));
    }

    public static Where unmarshal(XMLScanner xs) throws UnmarshalException {
        return Where.unmarshal(xs, Where.newDispatcher());
    }

    public static Where unmarshal(XMLScanner xs, Dispatcher d) throws UnmarshalException {
        return (Where)d.unmarshal(xs, Where.class);
    }
