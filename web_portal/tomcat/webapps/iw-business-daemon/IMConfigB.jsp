...
<FRAMESET ROWS="70%,30%">
<frame src='<%= "BDConfiguratorB.jsp" + (ConfigContext.isHosted()?("?CurrentProfile=" + java.net.URLEncoder.encode(currentProfileName, "UTF-8") + brandSol + e2C):brandSol1)%>' name="main">
<frame name="data">
<%}else{%>
<jsp:forward page="/ErrorMessage.jsp">
	<jsp:param name="ErrorMessageText" value='<%= (currentProfileName==null)?"Your profile B is lost. Please press Reset below and login again":"Your session has been lost. Please refresh your browser. If error persists please click Reset button below."%>'/>
