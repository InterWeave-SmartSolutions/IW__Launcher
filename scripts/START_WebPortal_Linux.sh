...
echo ""
echo "  Main Page:     http://localhost:9090"
echo "  DB Test Page:  http://localhost:9090/db_test.jsp"
echo "  IW Daemon:     http://localhost:9090/iw-business-daemon/"
echo ""
echo "To stop the web portal, run (from repo root): ./web_portal/stop_web_portal.sh"
echo "=============================================================================="
echo ""
