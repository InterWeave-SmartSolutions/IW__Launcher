...
REM Set paths (relative to project root, one level up from scripts/)
set "IW_HOME=%~dp0.."
set "WEB_INF=%IW_HOME%\web_portal\tomcat\webapps\iw-business-daemon\WEB-INF"
set "CLASSES=%WEB_INF%\classes"
set "LIB=%WEB_INF%\lib"
set "TOMCAT_LIB=%IW_HOME%\web_portal\tomcat\lib"
